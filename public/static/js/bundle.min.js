...
"use strict";function _defineProperty(t,e,r){return e in t?Object.defineProperty(t,e,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[e]=r,t}function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}var isNode="undefined"==typeof window;isNode&&(axios=require("axios"),SETTINGS=require("./settings.js"),CACHED_HOMEPAGE=[]);var B_MEDIA_PROTOCOL="19HxigV4QyBv3tHpQVcUEQyq1pzZVdoAut",BCAT_MEDIA_PROTOCOL="15DHFxWZJT58f9nhyGnsRBqrgwK4W6h4Up",SUPPORTED_TIPCHAIN_PROTOCOLS=["bit://"+B_MEDIA_PROTOCOL+"/","b://","bit://"+BCAT_MEDIA_PROTOCOL+"/","https://bico.media/","https://www.bitpaste.app/tx/","https://memo.sv/post/","https://dir.sv/category/","https://dir.sv/link/","https://bitstagram.bitdb.network/m/raw/"],OPENDIR_PROTOCOL="1dirzgocAsru3SdhetQkEJraQgYTf5xQm",OPENDIR_ACTIONS=["category.create","category.update","category.delete","entry.create","entry.update","entry.delete","vote","undo","fork.soft"];function get_root_category_txid(){return SETTINGS.category?SETTINGS.category:null}function toBase64(t){return isNode?Buffer.from(t).toString("base64"):btoa(t)}function get_bmedia_bitdb_query(t){return{v:3,q:{db:["u","c"],limit:2<arguments.length&&void 0!==arguments[2]?arguments[2]:100,sort:{txid:1},aggregate:[{$match:{"tx.h":{$in:t}}},{$skip:1<arguments.length&&void 0!==arguments[1]?arguments[1]:0}]},r:{f:'[.[] | {                                  "height": .blk.i?,                        "time": .blk.t?,                        "address": .in[0].e.a,                    "outputs": [.out[] | {"address": .e.a, "sats": .e.v}],                 "txid": .tx.h,                            "data": .out[0] | with_entries(select(((.key | startswith("s")) and (.key != "str"))))}]'}}}function get_bitdb_query(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:null,e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,r=2<arguments.length&&void 0!==arguments[2]?arguments[2]:1e3,n=3<arguments.length&&void 0!==arguments[3]?arguments[3]:5;null==t&&(t=get_root_category_txid());var o={v:3,q:{db:["u","c"],limit:r,sort:{txid:1},aggregate:[{$match:{$and:[{"out.s1":OPENDIR_PROTOCOL}]}},{$graphLookup:{from:"c",startWith:"$tx.h",connectFromField:"tx.h",connectToField:"out.s3",as:"confirmed_children",maxDepth:n}},{$project:{confirmed_children:"$confirmed_children",object:["$$ROOT"]}},{$project:{"object.confirmed_children":0}},{$project:{items:{$concatArrays:["$object","$confirmed_children"]}}},{$unwind:{path:"$items",preserveNullAndEmptyArrays:!0}},{$replaceRoot:{newRoot:"$items"}},{$graphLookup:{from:"u",startWith:"$tx.h",connectFromField:"tx.h",connectToField:"out.s3",as:"unconfirmed_children",maxDepth:n}},{$project:{unconfirmed_children:"$unconfirmed_children",object:["$$ROOT"]}},{$project:{"object.unconfirmed_children":0}},{$project:{items:{$concatArrays:["$object","$unconfirmed_children"]}}},{$unwind:{path:"$items",preserveNullAndEmptyArrays:!0}},{$replaceRoot:{newRoot:"$items"}},{$graphLookup:{from:"c",startWith:"$out.s3",connectFromField:"out.s3",connectToField:"tx.h",as:"confirmed_parent"}},{$project:{confirmed_parent:"$confirmed_parent",object:["$$ROOT"]}},{$project:{"object.confirmed_parent":0}},{$project:{items:{$concatArrays:["$object","$confirmed_parent"]}}},{$unwind:{path:"$items",preserveNullAndEmptyArrays:!0}},{$replaceRoot:{newRoot:"$items"}},{$graphLookup:{from:"u",startWith:"$out.s3",connectFromField:"out.s3",connectToField:"tx.h",as:"unconfirmed_parent"}},{$project:{unconfirmed_parent:"$unconfirmed_parent",object:["$$ROOT"]}},{$project:{"object.unconfirmed_parent":0}},{$project:{items:{$concatArrays:["$object","$unconfirmed_parent"]}}},{$unwind:{path:"$items",preserveNullAndEmptyArrays:!0}},{$replaceRoot:{newRoot:"$items"}},{$addFields:{b_txid:[{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"bit://"+B_MEDIA_PROTOCOL+"/"]},1]}},{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"b://"]},1]}},{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"bit://"+BCAT_MEDIA_PROTOCOL+"/"]},1]}},{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"bcat://"]},1]}},{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"https://bico.media/"]},1]}},{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"https://www.bitpaste.app/tx/"]},1]}},{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"https://memo.sv/post/"]},1]}},{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"https://dir.sv/category/"]},1]}},{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"https://dir.sv/link/"]},1]}},{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"https://bitstagram.bitdb.network/m/raw/"]},1]}}]}},{$lookup:{from:"c",localField:"b_txid.txid",foreignField:"tx.h",as:"confirmed_bmediatx"}},{$project:{confirmed_bmediatx:"$confirmed_bmediatx",object:["$$ROOT"]}},{$project:{"object.confirmed_bmediatx":0,"object.b_txid":0}},{$project:{"confirmed_bmediatx.tx":1,"confirmed_bmediatx.blk":1,"confirmed_bmediatx.in":1,"confirmed_bmediatx.out.s1":1,"confirmed_bmediatx.out.e":1,object:1}},{$project:{items:{$concatArrays:["$object","$confirmed_bmediatx"]}}},{$unwind:{path:"$items",preserveNullAndEmptyArrays:!0}},{$replaceRoot:{newRoot:"$items"}},{$lookup:{from:"u",localField:"b_txid.txid",foreignField:"tx.h",as:"unconfirmed_bmediatx"}},{$project:{unconfirmed_bmediatx:"$unconfirmed_bmediatx",object:["$$ROOT"]}},{$project:{"object.unconfirmed_bmediatx":0,"object.b_txid":0}},{$project:{"unconfirmed_bmediatx.tx":1,"unconfirmed_bmediatx.blk":1,"unconfirmed_bmediatx.in":1,"unconfirmed_bmediatx.out.s1":1,"unconfirmed_bmediatx.out.e":1,object:1}},{$project:{items:{$concatArrays:["$object","$unconfirmed_bmediatx"]}}},{$unwind:{path:"$items",preserveNullAndEmptyArrays:!0}},{$replaceRoot:{newRoot:"$items"}},{$project:{_id:0}},{$addFields:{_id:"$tx.h"}},{$group:{_id:null,items:{$addToSet:"$$ROOT"}}},{$unwind:{path:"$items"}},{$replaceRoot:{newRoot:"$items"}},{$skip:e}]},r:{f:'[.[] | {                                  "height": .blk.i?,                        "time": .blk.t?,                        "address": .in[0].e.a,                    "outputs": [.out[] | {"address": .e.a, "sats": .e.v}],                 "txid": .tx.h,                            "data": .out[0] | with_entries(select(((.key | startswith("s")) and (.key != "str"))))}]'}};return t?o.q.aggregate[0].$match.$and.push({$or:[{"tx.h":t},{"out.s3":t}]}):o.q.aggregate[0].$match.$and.push({$or:[{$and:[{"out.s2":"fork.soft"},{"out.s4":null}]},{$and:[{"out.s2":"category.create"},{"out.s3":"name"}]}]}),o}function fetch_from_network(){var y=0<arguments.length&&void 0!==arguments[0]?arguments[0]:null,p=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,h=2<arguments.length&&void 0!==arguments[2]?arguments[2]:1e3,v=3<arguments.length&&void 0!==arguments[3]?arguments[3]:[],m=!(4<arguments.length&&void 0!==arguments[4])||arguments[4];null==y&&(y=get_root_category_txid());var t=get_bitdb_query(y,p,h),e=toBase64(JSON.stringify(t)),n=SETTINGS.api_endpoint.replace("{api_key}",SETTINGS.api_key).replace("{api_action}","q").replace("{query}",e),o={headers:{key:SETTINGS.api_key}};function i(t,e,r){if(r.errors)e("error during query "+r.errors);else{var n={},o=r.c.concat(r.u).reverse();if(v=v.concat(o),p+=o.length,o.length>=h)console.log("Seems like there's still more... polling for more"),fetch_from_network(y,p,h,v,m).then(t).catch(e);else{var i=v.sort(function(t,e){return(null===t.height)-(null===e.height)||+(t.height>e.height)||-(t.height<e.height)}),a=(n=new Map,!0),c=!1,s=void 0;try{for(var l,u=i[Symbol.iterator]();!(a=(l=u.next()).done);a=!0){var d=l.value,f=n[d.txid];f&&(!f||f.height)||n.set(d.txid,d)}}catch(t){c=!0,s=t}finally{try{a||null==u.return||u.return()}finally{if(c)throw s}}t(Array.from(n.values()))}}}return new Promise(function(e,r){m&&null==y?e(CACHED_HOMEPAGE):(console.log("Making HTTP request to server "+p+","+h),isNode?(axios=require("axios"),axios(n,o).then(function(t){200===t.status?i(e,r,t.data):r("Error while retrieving response from server "+t.status)}).catch(r)):fetch(n,o).then(function(t){if(200===t.status)return t.json();r("Error while retrieving response from server "+t.status)}).then(function(t){i(e,r,t)}).catch(r))})}function fetch_bmedia_from_network(y){var p=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,h=2<arguments.length&&void 0!==arguments[2]?arguments[2]:20,v=3<arguments.length&&void 0!==arguments[3]?arguments[3]:[],t=get_bmedia_bitdb_query(y,p,h),n="https://genesis.bitdb.network/q/1FnauZ9aUH2Bex6JzdcV4eNX7oLSSEbxtN/"+btoa(JSON.stringify(t)),o={headers:{key:"1A4xFjNatCgAK5URARbVwoxo1E3MCMETb6"}};return new Promise(function(e,r){console.log("Making genesis HTTP request to server "+p+","+h),fetch(n,o).then(function(t){if(200===t.status)return t.json();r("Error while retrieving response from server "+t.status)}).then(function(t){!function(t,e,r){if(r.errors)e("error during query "+r.errors);else{var n={},o=r.c.concat(r.u).reverse();if(v=v.concat(o),p+=o.length,o.length>=h)console.log("Seems like there's still more... polling for more"),fetch_bmedia_from_network(y,p,h,v).then(t).catch(e);else{var i=v.sort(function(t,e){return(null===t.height)-(null===e.height)||+(t.height>e.height)||-(t.height<e.height)}),a=(n=new Map,!0),c=!1,s=void 0;try{for(var l,u=i[Symbol.iterator]();!(a=(l=u.next()).done);a=!0){var d=l.value,f=n[d.txid];f&&(!f||f.height)||n.set(d.txid,d)}}catch(t){c=!0,s=t}finally{try{a||null==u.return||u.return()}finally{if(c)throw s}}t(Array.from(n.values()))}}}(e,r,t)}).catch(r)})}function processOpenDirectoryTransactions(t){return t.map(processOpenDirectoryTransaction).filter(function(t){return t})}function findChildrenByActionID(t){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[],r=[],n=!0,o=!1,i=void 0;try{for(var a,c=e[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){var s=a.value;if(s.action_id==t.txid){var l=findChildrenByActionID(s,e);r=r.concat([s],l)}}}catch(t){o=!0,i=t}finally{try{n||null==c.return||c.return()}finally{if(o)throw i}}return r}function processUndos(t){var e={},r=!0,n=!1,o=void 0;try{for(var i,a=t[Symbol.iterator]();!(r=(i=a.next()).done);r=!0){var c=i.value;e[c.txid]=c}}catch(t){n=!0,o=t}finally{try{r||null==a.return||a.return()}finally{if(n)throw o}}var s=[],l=!0,u=!1,d=void 0;try{for(var f,y=t[Symbol.iterator]();!(l=(f=y.next()).done);l=!0){var p=f.value;e[p.action_id]||s.push(p)}}catch(t){u=!0,d=t}finally{try{l||null==y.return||y.return()}finally{if(u)throw d}}for(var h=new Set,v=0,m=s;v<m.length;v++){for(var g=findChildrenByActionID(m[v],t),_={},$=g.length-1;0<=$;$--){var b=g[$];"undo"===b.type&&(_[b.txid]||(_[b.action_id]=b))}for(var x in _)h.add(x)}return Array.from(h)}function processRawResults(t){return processResults(t,processOpenDirectoryTransactions(t))}function processResults(e,t){var r=[],n=processUndos(t);function o(t){return processResult(t,r,n,e)}var i=!0,a=!1,c=void 0;try{for(var s,l=t.filter(function(t){return"category"==t.type&&"create"==t.action})[Symbol.iterator]();!(i=(s=l.next()).done);i=!0){var u=s.value;r=o(u)}}catch(t){a=!0,c=t}finally{try{i||null==l.return||l.return()}finally{if(a)throw c}}var d=!0,f=!1,y=void 0;try{for(var p,h=t.filter(function(t){return"category"==t.type&&"update"==t.action})[Symbol.iterator]();!(d=(p=h.next()).done);d=!0){var v=p.value;r=o(v)}}catch(t){f=!0,y=t}finally{try{d||null==h.return||h.return()}finally{if(f)throw y}}var m=!0,g=!1,_=void 0;try{for(var $,b=t.filter(function(t){return"category"==t.type&&"delete"==t.action})[Symbol.iterator]();!(m=($=b.next()).done);m=!0){var x=$.value;r=o(x)}}catch(t){g=!0,_=t}finally{try{m||null==b.return||b.return()}finally{if(g)throw _}}var O=!0,T=!1,w=void 0;try{for(var j,E=t.filter(function(t){return"entry"==t.type&&"create"==t.action})[Symbol.iterator]();!(O=(j=E.next()).done);O=!0){var R=j.value;r=o(R)}}catch(t){T=!0,w=t}finally{try{O||null==E.return||E.return()}finally{if(T)throw w}}var A=!0,S=!1,k=void 0;try{for(var P,N=t.filter(function(t){return"entry"==t.type&&"update"==t.action})[Symbol.iterator]();!(A=(P=N.next()).done);A=!0){var C=P.value;r=o(C)}}catch(t){S=!0,k=t}finally{try{A||null==N.return||N.return()}finally{if(S)throw k}}var I=!0,D=!1,B=void 0;try{for(var F,M=t.filter(function(t){return"entry"==t.type&&"delete"==t.action})[Symbol.iterator]();!(I=(F=M.next()).done);I=!0){var q=F.value;r=o(q)}}catch(t){D=!0,B=t}finally{try{I||null==M.return||M.return()}finally{if(D)throw B}}r=processTipchain(r,t);var L=!0,U=!1,H=void 0;try{for(var V,X=t.filter(function(t){return"vote"==t.type})[Symbol.iterator]();!(L=(V=X.next()).done);L=!0){var G=V.value;r=o(G)}}catch(t){U=!0,H=t}finally{try{L||null==X.return||X.return()}finally{if(U)throw H}}var J=!0,K=!1,Q=void 0;try{for(var W,z=t.filter(function(t){return"fork"==t.type})[Symbol.iterator]();!(J=(W=z.next()).done);J=!0){var Z=W.value;r=o(Z)}}catch(t){K=!0,Q=t}finally{try{J||null==z.return||z.return()}finally{if(K)throw Q}}for(var Y=0,tt=[updateCategoryEntryCounts,updateCategoryMoneyCounts,updateHottness];Y<tt.length;Y++){r=(0,tt[Y])(r)}return r}function updateHottness(t){return t.map(function(t){return"entry"!=t.type&&"category"!=t.type||(t.hottness=calculateHottness(t)),t})}function calculateHottness(t){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:1.8,r=1*(t.satoshis+t.votes),n=(new Date).getTime()/1e3,o=(t.time?n-t.time:0)/3600;return r/Math.pow(2+o,e)}function processTipchainResult(t,e,r,n){var o=JSON.parse(JSON.stringify(SETTINGS.tip_addresses)),i={address:t.address,txid:t.txid,type:t.type},a=o.concat(i);if(t.category){var c=findObjectByTX(t.category,e);c&&(processTipchainResult(c,e,r,n),a=c.tipchain.concat([i]))}if("entry"==t.type){var s=parseTipFromEntryMedia(t,n);s&&a.push(s)}var l=(t.tipchain=a).map(function(t){return t.address}),u=convertOutputs(t.outputs,l);t.satoshis=u}function processTipchain(t,e){var r={},n=!0,o=!1,i=void 0;try{for(var a,c=e.filter(function(t){return"other"==t.type})[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){var s=a.value;r[s.txid]=s}}catch(t){o=!0,i=t}finally{try{n||null==c.return||c.return()}finally{if(o)throw i}}var l=!0,u=!1,d=void 0;try{for(var f,y=t[Symbol.iterator]();!(l=(f=y.next()).done);l=!0){var p=f.value;"entry"!==p.type&&"category"!==p.type||processTipchainResult(p,t,e,r)}}catch(t){u=!0,d=t}finally{try{l||null==y.return||y.return()}finally{if(u)throw d}}return t}function processCategoryResult(t,e,r,n){if(-1!==r.indexOf(t.txid))return e;if("create"==t.action){var o=t.change;t.action_id&&(o.category=t.action_id),o.type=t.type,o.txid=t.txid,o.address=t.address,o.height=t.height,o.time=t.time,o.outputs=t.outputs,o.votes=0,o.entries=0,e.push(o)}else if("update"==t.action){var i=findObjectByTX(t.action_id,e);if(i)for(var a in t.change)i[a]=t.change[a];else console.log("couldn't find category for update",i,t)}else if("delete"==t.action){var c=findObjectByTX(t.action_id,e);c?c.deleted=!0:console.log("couldn't find object for delete",c,t)}else console.log("error processing category",t);return e}function processEntryResult(t,e,r,n){if(-1!==r.indexOf(t.txid))return e;if("create"==t.action){var o=t.change;t.action_id&&(o.category=t.action_id),o.type=t.type,o.txid=t.txid,o.address=t.address,o.height=t.height,o.time=t.time,o.outputs=t.outputs,o.hottness=0,o.votes=0,e.push(o)}else if("update"==t.action){var i=findObjectByTX(t.action_id,e);if(i)for(var a in t.change)i[a]=t.change[a];else console.log("couldn't find category for update",i,t,e)}else if("delete"==t.action){var c=findObjectByTX(t.action_id,e);c?c.deleted=!0:console.log("couldn't find object for delete",c,t)}else console.log("error processing entry",t);return e}function processVoteResult(t,e,r,n){var o=findObjectByTX(t.action_id,e);if(o){var i=o.tipchain.map(function(t){return t.address}),a=convertOutputs(t.outputs,i);if(-1==r.indexOf(t.txid)&&(o.votes+=1,o.satoshis+=a),0<a)for(var c in n)n[c].txid==t.txid&&(n[c].satoshis=a)}else console.log("couldn't find object for vote",o,t);return e}function processForkResult(t,e,r){var n=[];if(t.action_id){var o=findObjectByTX(t.action_id,e);o&&(n=o.tipchain.map(function(t){return t.address}))}else n=SETTINGS.tip_address;var i=convertOutputs(t.outputs,n);if(t.satoshis?t.satoshis+=i:t.satoshis=i,0<i)for(var a in r)r[a].txid==t.txid&&(r[a].satoshis=i);return e}function processResult(t,e,r,n){switch(t.type){case"category":return processCategoryResult(t,e,r,n);case"entry":return processEntryResult(t,e,r,n);case"vote":return processVoteResult(t,e,r,n);case"fork":return processForkResult(t,e,n);default:return console.log("error processing result",t),e}}function parseTipFromEntryMedia(t,e){for(var r=0,n=SUPPORTED_TIPCHAIN_PROTOCOLS;r<n.length;r++){var o=n[r],i=t.link.split(o);if(2==i.length){var a=i[1];if(64==a.length){var c=e[a];if(c)return{address:c.address,type:"media"};console.log("unable to find associated b media for item",t.txid,"media txid",a)}}}return null}function updateCategoryMoneyCounts(e){return e.map(function(t){return"category"==t.type&&(t.satoshis=countMoneyUnderObject(t,e),t.votes=countVotesUnderObject(t,e)),t})}function countMoneyUnderObject(t,e){var r=t.satoshis,n=!0,o=!1,i=void 0;try{for(var a,c=e[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){var s=a.value;s.deleted||s.category!=t.txid||(r+=s.satoshis,"category"==s.type&&(r+=countMoneyUnderObject(s,e)))}}catch(t){o=!0,i=t}finally{try{n||null==c.return||c.return()}finally{if(o)throw i}}return r}function countVotesUnderObject(t,e){var r=t.votes,n=!0,o=!1,i=void 0;try{for(var a,c=e[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){var s=a.value;s.deleted||s.category!=t.txid||(r+=s.votes,"category"==s.type&&(r+=countVotesUnderObject(s,e)))}}catch(t){o=!0,i=t}finally{try{n||null==c.return||c.return()}finally{if(o)throw i}}return r}function updateCategoryEntryCounts(e){return e.map(function(t){return"category"==t.type&&(t.entries=countObjectsUnderObject(t,e)),t})}function countObjectsUnderObject(t,e){var r=0,n=!0,o=!1,i=void 0;try{for(var a,c=e[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){var s=a.value;s.deleted||s.category!=t.txid||(r+=1,"category"==s.type&&(r+=countObjectsUnderObject(s,e)))}}catch(t){o=!0,i=t}finally{try{n||null==c.return||c.return()}finally{if(o)throw i}}return r}function expandTipchainInformation(t){for(var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,r=2<arguments.length&&void 0!==arguments[2]?arguments[2]:[],n=t.slice(0).reverse(),o=n.map(function(t){return t.address}),i=calculateTipchainSplits(n).reverse(),a=[],c=0;c<o.length;c++){var s=n[c],l=s.name;if(!l&&s.txid){var u=findObjectByTX(s.txid,r);u&&(l=u.name)}l||(l="");var d=i[c],f=e*d;a.push({address:s.address,type:s.type,split:d,amount:f,name:l})}return a}function convertKeyValues(t){for(var e=JSON.parse(JSON.stringify(t)),r={},n=null,o=null,i=null;i=e.shift();)n?o=i:n=i,n&&o&&(r[n]=o,o=n=null);return r}function calculateTipchainSplits(t){if(0==t.length)return[];for(var e=[],r=1;r<=t.length;r++)e.push(1+Math.log(r));var n=e.reduce(function(t,e){return t+e});return e.map(function(t){return t/n})}function calculateTipPayment(t,e,r){if(!e)return console.log("error while calculating tip payment, invalid amount"),null;if(!r)return console.log("error while calculating tip payment, invalid currency"),null;var n=calculateTipchainSplits(t);if(n.length!=t.length)return console.log("error while calculating tip payment, weights didn't match tipchain length"),null;for(var o=[],i=0;i<t.length;i++){var a="object"==_typeof(t[i])?t[i].address:t[i],c=n[i],s=Math.round(c*e*1e4)/1e4;0<s&&o.push({address:a,value:s,currency:r})}return o}function processOpenDirectoryTransaction(t){var e;if(!t.txid||!t.data||!t.address)return null;var r,n,o=t.txid,i=t.address,a=t.height?t.height:Math.Infinity,c=t.time?t.time:0,s=t.outputs?t.outputs:[],l=Object.values(t.data),u=l.shift(),d=l.shift();if(!o)return console.log("Error while processing open directory transaction: no txid",t),null;if(u!==OPENDIR_PROTOCOL)return{txid:t.txid,address:t.address,height:a,time:c,type:"other"};if(-1==OPENDIR_ACTIONS.indexOf(d))return console.log("Error while processing open directory transaction: invalid action",t),{txid:t.txid,address:t.address,height:a,time:c,type:"other"};if("vote"==d||"undo"==d)r=n=d;else{var f=d.split(".");if(2!=f.length)return console.log("Error while processing open directory transaction: invalid action",t),null;r=f[0],n=f[1]}var y=(_defineProperty(e={type:r},"type",r),_defineProperty(e,"action",n),_defineProperty(e,"txid",o),_defineProperty(e,"address",i),_defineProperty(e,"height",a),_defineProperty(e,"time",c),_defineProperty(e,"outputs",s),e);if("category"==r)if("create"==n)l.length%2==1&&(y.action_id=l.shift()),y.change=convertKeyValues(l);else if("update"==n)y.action_id=l.shift(),y.change=convertKeyValues(l);else if("delete"==n){y.action_id=l.shift();var p=l.shift();p&&(y.description=p,t.description=p)}else console.log("unknown category action",t);else if("entry"==r)if("create"==n)y.action_id=l.shift(),y.change=convertKeyValues(l);else if("update"==n)y.action_id=l.shift(),y.change=convertKeyValues(l);else if("delete"==n){y.action_id=l.shift();var h=l.shift();h&&(y.description=h,t.description=h)}else console.log("unknown entry action",t);else if("vote"==r)y.action_id=l.shift();else if("fork"==r)if(2==l.length)y.fork_url=l.shift();else{if(3!=l.length)return console.log("unknown number of args",t),null;y.fork_url=l.shift(),y.action_id=l.shift()}else"undo"==r?(1==l.length?(y.reference_id=l.shift(),y.action_id=y.reference_id):2==l.length?(y.reference_id=l.shift(),y.action_id=l.shift()):(y.reference_id=l.shift(),y.action_id=l.shift(),y.description=l.shift()),y.reference_id&&(t.reference_id=y.reference_id),y.action_id&&(t.action_id=y.action_id),y.description&&(t.description=y.description)):console.log("unknown item type",t);return y}function convertOutputs(t){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[],r=0,n=!0,o=!1,i=void 0;try{for(var a,c=t[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){var s=a.value;-1!==e.indexOf(s.address)&&(r+=s.sats)}}catch(t){o=!0,i=t}finally{try{n||null==c.return||c.return()}finally{if(o)throw i}}return r}function findObjectByTX(t){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[],r=!0,n=!1,o=void 0;try{for(var i,a=e[Symbol.iterator]();!(r=(i=a.next()).done);r=!0){var c=i.value;if(c.txid==t)return c}}catch(t){n=!0,o=t}finally{try{r||null==a.return||a.return()}finally{if(n)throw o}}return null}function findRootActionID(t){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[];if(!t.action_id)return null;if("undo"==t.type&&t.action_id){var r=findObjectByTX(t.action_id,e);if(r&&"undo"==r.type){var n=findRootActionID(r,e);if(n)return n}}return t.action_id}"undefined"==typeof window&&(module.exports={OPENDIR_PROTOCOL:OPENDIR_PROTOCOL,OPENDIR_ACTIONS:OPENDIR_ACTIONS,fetch_from_network:fetch_from_network,processResults:processResults,processRawResults:processRawResults,processOpenDirectoryTransactions:processOpenDirectoryTransactions,calculateTipchainSplits:calculateTipchainSplits,calculateTipPayment:calculateTipPayment,findObjectByTX:findObjectByTX});
