...
"use strict";function _typeof(o){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(o){return typeof o}:function(o){return o&&"function"==typeof Symbol&&o.constructor===Symbol&&o!==Symbol.prototype?"symbol":typeof o})(o)}if(!SETTINGS){if("object"==("undefined"==typeof window?"undefined":_typeof(window)))throw"Error reading global settings...";var SETTINGS={api_key:"1D23Q8m3GgPFH15cwseLFZVVGSNg3ypP2z",api_endpoint:"https://bitomation.com/{api_action}/{api_key}/{query}",tip_addresses:[{address:"1LPe8CGxypahVkoBbYyoHMUAHuPb4S2JKL",name:"Open Directory",type:"opendirectory"}]}}function get_local_settings(){var o=window.localStorage.settings;if(o)try{return JSON.parse(o)}catch(o){}return{}}function save_local_settings(o){o?(window.localStorage.settings=JSON.stringify(o),console.log("Saving local settings",o)):delete window.localStorage.settings}function use_local_settings(o){if(o&&0<Object.keys(o).length)for(var t in console.log("Found local settings",o),o){var e=o[t];console.log("Local setting override",t,e),SETTINGS[t]=e}}var BSV_PRICE=53;"object"==("undefined"==typeof window?"undefined":_typeof(window))?use_local_settings(get_local_settings()):module.exports=SETTINGS;
...
"use strict";function _defineProperty(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}var isNode="undefined"==typeof window;isNode&&(axios=require("axios"),SETTINGS=require("./settings.js"),CACHED_HOMEPAGE=[]);var B_MEDIA_PROTOCOL="19HxigV4QyBv3tHpQVcUEQyq1pzZVdoAut",BCAT_MEDIA_PROTOCOL="15DHFxWZJT58f9nhyGnsRBqrgwK4W6h4Up",SUPPORTED_TIPCHAIN_PROTOCOLS=["bit://"+B_MEDIA_PROTOCOL+"/","b://","bit://"+BCAT_MEDIA_PROTOCOL+"/"],OPENDIR_PROTOCOL="1dirzgocAsru3SdhetQkEJraQgYTf5xQm",OPENDIR_ACTIONS=["category.create","category.update","category.delete","entry.create","entry.update","entry.delete","vote","undo","fork.soft"];function get_root_category_txid(){return SETTINGS.category?SETTINGS.category:null}function toBase64(e){return isNode?Buffer.from(e).toString("base64"):btoa(e)}function get_bmedia_bitdb_query(e){return{v:3,q:{db:["u","c"],limit:2<arguments.length&&void 0!==arguments[2]?arguments[2]:100,sort:{txid:1},aggregate:[{$match:{"tx.h":{$in:e}}},{$skip:1<arguments.length&&void 0!==arguments[1]?arguments[1]:0}]},r:{f:'[.[] | {                                  "height": .blk.i?,                        "time": .blk.t?,                        "address": .in[0].e.a,                    "outputs": [.out[] | {"address": .e.a, "sats": .e.v}],                 "txid": .tx.h,                            "data": .out[0] | with_entries(select(((.key | startswith("s")) and (.key != "str"))))}]'}}}function get_bitdb_query(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:null,t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,r=2<arguments.length&&void 0!==arguments[2]?arguments[2]:1e3,n=3<arguments.length&&void 0!==arguments[3]?arguments[3]:5;null==e&&(e=get_root_category_txid());var o={v:3,q:{db:["u","c"],limit:r,sort:{txid:1},aggregate:[{$match:{$and:[{"out.s1":OPENDIR_PROTOCOL}]}},{$graphLookup:{from:"c",startWith:"$tx.h",connectFromField:"tx.h",connectToField:"out.s3",as:"confirmed_children",maxDepth:n}},{$project:{confirmed_children:"$confirmed_children",object:["$$ROOT"]}},{$project:{"object.confirmed_children":0}},{$project:{items:{$concatArrays:["$object","$confirmed_children"]}}},{$unwind:{path:"$items",preserveNullAndEmptyArrays:!0}},{$replaceRoot:{newRoot:"$items"}},{$graphLookup:{from:"u",startWith:"$tx.h",connectFromField:"tx.h",connectToField:"out.s3",as:"unconfirmed_children",maxDepth:n}},{$project:{unconfirmed_children:"$unconfirmed_children",object:["$$ROOT"]}},{$project:{"object.unconfirmed_children":0}},{$project:{items:{$concatArrays:["$object","$unconfirmed_children"]}}},{$unwind:{path:"$items",preserveNullAndEmptyArrays:!0}},{$replaceRoot:{newRoot:"$items"}},{$graphLookup:{from:"c",startWith:"$out.s3",connectFromField:"out.s3",connectToField:"tx.h",as:"confirmed_parent"}},{$project:{confirmed_parent:"$confirmed_parent",object:["$$ROOT"]}},{$project:{"object.confirmed_parent":0}},{$project:{items:{$concatArrays:["$object","$confirmed_parent"]}}},{$unwind:{path:"$items",preserveNullAndEmptyArrays:!0}},{$replaceRoot:{newRoot:"$items"}},{$graphLookup:{from:"u",startWith:"$out.s3",connectFromField:"out.s3",connectToField:"tx.h",as:"unconfirmed_parent"}},{$project:{unconfirmed_parent:"$unconfirmed_parent",object:["$$ROOT"]}},{$project:{"object.unconfirmed_parent":0}},{$project:{items:{$concatArrays:["$object","$unconfirmed_parent"]}}},{$unwind:{path:"$items",preserveNullAndEmptyArrays:!0}},{$replaceRoot:{newRoot:"$items"}},{$addFields:{b_txid:[{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"bit://"+B_MEDIA_PROTOCOL+"/"]},1]}},{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"b://"]},1]}},{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"bit://"+BCAT_MEDIA_PROTOCOL+"/"]},1]}},{txid:{$arrayElemAt:[{$split:[{$arrayElemAt:["$out.s7",0]},"bcat://"]},1]}}]}},{$lookup:{from:"c",localField:"b_txid.txid",foreignField:"tx.h",as:"confirmed_bmediatx"}},{$project:{confirmed_bmediatx:"$confirmed_bmediatx",object:["$$ROOT"]}},{$project:{"object.confirmed_bmediatx":0,"object.b_txid":0}},{$project:{"confirmed_bmediatx.tx":1,"confirmed_bmediatx.blk":1,"confirmed_bmediatx.in":1,"confirmed_bmediatx.out.s1":1,"confirmed_bmediatx.out.e":1,object:1}},{$project:{items:{$concatArrays:["$object","$confirmed_bmediatx"]}}},{$unwind:{path:"$items",preserveNullAndEmptyArrays:!0}},{$replaceRoot:{newRoot:"$items"}},{$lookup:{from:"u",localField:"b_txid.txid",foreignField:"tx.h",as:"unconfirmed_bmediatx"}},{$project:{unconfirmed_bmediatx:"$unconfirmed_bmediatx",object:["$$ROOT"]}},{$project:{"object.unconfirmed_bmediatx":0,"object.b_txid":0}},{$project:{"unconfirmed_bmediatx.tx":1,"unconfirmed_bmediatx.blk":1,"unconfirmed_bmediatx.in":1,"unconfirmed_bmediatx.out.s1":1,"unconfirmed_bmediatx.out.e":1,object:1}},{$project:{items:{$concatArrays:["$object","$unconfirmed_bmediatx"]}}},{$unwind:{path:"$items",preserveNullAndEmptyArrays:!0}},{$replaceRoot:{newRoot:"$items"}},{$project:{_id:0}},{$addFields:{_id:"$tx.h"}},{$group:{_id:null,items:{$addToSet:"$$ROOT"}}},{$unwind:{path:"$items"}},{$replaceRoot:{newRoot:"$items"}},{$skip:t}]},r:{f:'[.[] | {                                  "height": .blk.i?,                        "time": .blk.t?,                        "address": .in[0].e.a,                    "outputs": [.out[] | {"address": .e.a, "sats": .e.v}],                 "txid": .tx.h,                            "data": .out[0] | with_entries(select(((.key | startswith("s")) and (.key != "str"))))}]'}};return e?o.q.aggregate[0].$match.$and.push({$or:[{"tx.h":e},{"out.s3":e}]}):o.q.aggregate[0].$match.$and.push({$or:[{$and:[{"out.s2":"fork.soft"},{"out.s4":null}]},{$and:[{"out.s2":"category.create"},{"out.s3":"name"}]}]}),o}function fetch_from_network(){var y=0<arguments.length&&void 0!==arguments[0]?arguments[0]:null,p=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,h=2<arguments.length&&void 0!==arguments[2]?arguments[2]:1e3,v=3<arguments.length&&void 0!==arguments[3]?arguments[3]:[],m=!(4<arguments.length&&void 0!==arguments[4])||arguments[4];null==y&&(y=get_root_category_txid());var e=get_bitdb_query(y,p,h),t=toBase64(JSON.stringify(e)),n=SETTINGS.api_endpoint.replace("{api_key}",SETTINGS.api_key).replace("{api_action}","q").replace("{query}",t),o={headers:{key:SETTINGS.api_key}};function i(e,t,r){if(r.errors)t("error during query "+r.errors);else{var n={},o=r.c.concat(r.u).reverse();if(v=v.concat(o),p+=o.length,o.length>=h)console.log("Seems like there's still more... polling for more"),fetch_from_network(y,p,h,v,m).then(e).catch(t);else{var i=v.sort(function(e,t){return(null===e.height)-(null===t.height)||+(e.height>t.height)||-(e.height<t.height)}),a=(n=new Map,!0),c=!1,s=void 0;try{for(var l,u=i[Symbol.iterator]();!(a=(l=u.next()).done);a=!0){var d=l.value,f=n[d.txid];f&&(!f||f.height)||n.set(d.txid,d)}}catch(e){c=!0,s=e}finally{try{a||null==u.return||u.return()}finally{if(c)throw s}}e(Array.from(n.values()))}}}return new Promise(function(t,r){m&&null==y?t(CACHED_HOMEPAGE):(console.log("Making HTTP request to server "+p+","+h),isNode?(axios=require("axios"),axios(n,o).then(function(e){200===e.status?i(t,r,e.data):r("Error while retrieving response from server "+e.status)}).catch(r)):fetch(n,o).then(function(e){if(200===e.status)return e.json();r("Error while retrieving response from server "+e.status)}).then(function(e){i(t,r,e)}).catch(r))})}function fetch_bmedia_from_network(y){var p=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,h=2<arguments.length&&void 0!==arguments[2]?arguments[2]:20,v=3<arguments.length&&void 0!==arguments[3]?arguments[3]:[],e=get_bmedia_bitdb_query(y,p,h),n="https://genesis.bitdb.network/q/1FnauZ9aUH2Bex6JzdcV4eNX7oLSSEbxtN/"+btoa(JSON.stringify(e)),o={headers:{key:"1A4xFjNatCgAK5URARbVwoxo1E3MCMETb6"}};return new Promise(function(t,r){console.log("Making genesis HTTP request to server "+p+","+h),fetch(n,o).then(function(e){if(200===e.status)return e.json();r("Error while retrieving response from server "+e.status)}).then(function(e){!function(e,t,r){if(r.errors)t("error during query "+r.errors);else{var n={},o=r.c.concat(r.u).reverse();if(v=v.concat(o),p+=o.length,o.length>=h)console.log("Seems like there's still more... polling for more"),fetch_bmedia_from_network(y,p,h,v).then(e).catch(t);else{var i=v.sort(function(e,t){return(null===e.height)-(null===t.height)||+(e.height>t.height)||-(e.height<t.height)}),a=(n=new Map,!0),c=!1,s=void 0;try{for(var l,u=i[Symbol.iterator]();!(a=(l=u.next()).done);a=!0){var d=l.value,f=n[d.txid];f&&(!f||f.height)||n.set(d.txid,d)}}catch(e){c=!0,s=e}finally{try{a||null==u.return||u.return()}finally{if(c)throw s}}e(Array.from(n.values()))}}}(t,r,e)}).catch(r)})}function processOpenDirectoryTransactions(e){return e.map(processOpenDirectoryTransaction).filter(function(e){return e})}function findChildrenByActionID(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[],r=[],n=!0,o=!1,i=void 0;try{for(var a,c=t[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){var s=a.value;if(s.action_id==e.txid){var l=findChildrenByActionID(s,t);r=r.concat([s],l)}}}catch(e){o=!0,i=e}finally{try{n||null==c.return||c.return()}finally{if(o)throw i}}return r}function processUndos(e){var t={},r=!0,n=!1,o=void 0;try{for(var i,a=e[Symbol.iterator]();!(r=(i=a.next()).done);r=!0){var c=i.value;t[c.txid]=c}}catch(e){n=!0,o=e}finally{try{r||null==a.return||a.return()}finally{if(n)throw o}}var s=[],l=!0,u=!1,d=void 0;try{for(var f,y=e[Symbol.iterator]();!(l=(f=y.next()).done);l=!0){var p=f.value;t[p.action_id]||s.push(p)}}catch(e){u=!0,d=e}finally{try{l||null==y.return||y.return()}finally{if(u)throw d}}for(var h=new Set,v=0,m=s;v<m.length;v++){for(var g=findChildrenByActionID(m[v],e),_={},b=g.length-1;0<=b;b--){var $=g[b];"undo"===$.type&&(_[$.txid]||(_[$.action_id]=$))}for(var x in _)h.add(x)}return Array.from(h)}function processRawResults(e){return processResults(e,processOpenDirectoryTransactions(e))}function processResults(t,e){var r=[],n=processUndos(e);function o(e){return processResult(e,r,n,t)}var i=!0,a=!1,c=void 0;try{for(var s,l=e.filter(function(e){return"category"==e.type&&"create"==e.action})[Symbol.iterator]();!(i=(s=l.next()).done);i=!0){var u=s.value;r=o(u)}}catch(e){a=!0,c=e}finally{try{i||null==l.return||l.return()}finally{if(a)throw c}}var d=!0,f=!1,y=void 0;try{for(var p,h=e.filter(function(e){return"category"==e.type&&"update"==e.action})[Symbol.iterator]();!(d=(p=h.next()).done);d=!0){var v=p.value;r=o(v)}}catch(e){f=!0,y=e}finally{try{d||null==h.return||h.return()}finally{if(f)throw y}}var m=!0,g=!1,_=void 0;try{for(var b,$=e.filter(function(e){return"category"==e.type&&"delete"==e.action})[Symbol.iterator]();!(m=(b=$.next()).done);m=!0){var x=b.value;r=o(x)}}catch(e){g=!0,_=e}finally{try{m||null==$.return||$.return()}finally{if(g)throw _}}var O=!0,T=!1,j=void 0;try{for(var w,R=e.filter(function(e){return"entry"==e.type&&"create"==e.action})[Symbol.iterator]();!(O=(w=R.next()).done);O=!0){var S=w.value;r=o(S)}}catch(e){T=!0,j=e}finally{try{O||null==R.return||R.return()}finally{if(T)throw j}}var E=!0,A=!1,P=void 0;try{for(var k,C=e.filter(function(e){return"entry"==e.type&&"update"==e.action})[Symbol.iterator]();!(E=(k=C.next()).done);E=!0){var N=k.value;r=o(N)}}catch(e){A=!0,P=e}finally{try{E||null==C.return||C.return()}finally{if(A)throw P}}var I=!0,D=!1,B=void 0;try{for(var F,M=e.filter(function(e){return"entry"==e.type&&"delete"==e.action})[Symbol.iterator]();!(I=(F=M.next()).done);I=!0){var q=F.value;r=o(q)}}catch(e){D=!0,B=e}finally{try{I||null==M.return||M.return()}finally{if(D)throw B}}r=processTipchain(r,e);var L=!0,U=!1,H=void 0;try{for(var V,X=e.filter(function(e){return"vote"==e.type})[Symbol.iterator]();!(L=(V=X.next()).done);L=!0){var G=V.value;r=o(G)}}catch(e){U=!0,H=e}finally{try{L||null==X.return||X.return()}finally{if(U)throw H}}var J=!0,K=!1,Q=void 0;try{for(var W,z=e.filter(function(e){return"fork"==e.type})[Symbol.iterator]();!(J=(W=z.next()).done);J=!0){var Z=W.value;r=o(Z)}}catch(e){K=!0,Q=e}finally{try{J||null==z.return||z.return()}finally{if(K)throw Q}}for(var Y=0,ee=[updateCategoryEntryCounts,updateCategoryMoneyCounts,updateHottness];Y<ee.length;Y++){r=(0,ee[Y])(r)}return r}function updateHottness(e){return e.map(function(e){return"entry"!=e.type&&"category"!=e.type||(e.hottness=calculateHottness(e)),e})}function calculateHottness(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:1.8,r=1*(e.satoshis+e.votes),n=(new Date).getTime()/1e3,o=(e.time?n-e.time:0)/3600;return r/Math.pow(2+o,t)}function processTipchainResult(e,t,r,n){var o=JSON.parse(JSON.stringify(SETTINGS.tip_addresses)),i={address:e.address,txid:e.txid,type:e.type},a=o.concat(i);if(e.category){var c=findObjectByTX(e.category,t);c&&(processTipchainResult(c,t,r,n),a=c.tipchain.concat([i]))}if("entry"==e.type){var s=parseTipFromEntryMedia(e,n);s&&a.push(s)}var l=(e.tipchain=a).map(function(e){return e.address}),u=convertOutputs(e.outputs,l);e.satoshis=u}function processTipchain(e,t){var r={},n=!0,o=!1,i=void 0;try{for(var a,c=t.filter(function(e){return"other"==e.type})[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){var s=a.value;r[s.txid]=s}}catch(e){o=!0,i=e}finally{try{n||null==c.return||c.return()}finally{if(o)throw i}}var l=!0,u=!1,d=void 0;try{for(var f,y=e[Symbol.iterator]();!(l=(f=y.next()).done);l=!0){var p=f.value;"entry"!==p.type&&"category"!==p.type||processTipchainResult(p,e,t,r)}}catch(e){u=!0,d=e}finally{try{l||null==y.return||y.return()}finally{if(u)throw d}}return e}function processCategoryResult(e,t,r,n){if(-1!==r.indexOf(e.txid))return t;if("create"==e.action){var o=e.change;e.action_id&&(o.category=e.action_id),o.type=e.type,o.txid=e.txid,o.address=e.address,o.height=e.height,o.time=e.time,o.outputs=e.outputs,o.votes=0,o.entries=0,t.push(o)}else if("update"==e.action){var i=findObjectByTX(e.action_id,t);if(i)for(var a in e.change)i[a]=e.change[a];else console.log("couldn't find category for update",i,e,t)}else if("delete"==e.action){var c=findObjectByTX(e.action_id,t);c?c.deleted=!0:console.log("couldn't find object for delete",c,e)}else console.log("error processing category",e);return t}function processEntryResult(e,t,r,n){if(-1!==r.indexOf(e.txid))return t;if("create"==e.action){var o=e.change;e.action_id&&(o.category=e.action_id),o.type=e.type,o.txid=e.txid,o.address=e.address,o.height=e.height,o.time=e.time,o.outputs=e.outputs,o.hottness=0,o.votes=0,t.push(o)}else if("update"==e.action){var i=findObjectByTX(e.action_id,t);if(i)for(var a in e.change)i[a]=e.change[a];else console.log("couldn't find category for update",i,e,t)}else if("delete"==e.action){var c=findObjectByTX(e.action_id,t);c?c.deleted=!0:console.log("couldn't find object for delete",c,e)}else console.log("error processing entry",e);return t}function processVoteResult(e,t,r,n){var o=findObjectByTX(e.action_id,t);if(o){var i=o.tipchain.map(function(e){return e.address}),a=convertOutputs(e.outputs,i);if(-1==r.indexOf(e.txid)&&(o.votes+=1,o.satoshis+=a),0<a)for(var c in n)n[c].txid==e.txid&&(n[c].satoshis=a)}else console.log("couldn't find object for vote",o,e);return t}function processForkResult(e,t,r){var n=[];if(e.action_id){var o=findObjectByTX(e.action_id,t);o&&(n=o.tipchain.map(function(e){return e.address}))}else n=SETTINGS.tip_address;var i=convertOutputs(e.outputs,n);if(e.satoshis?e.satoshis+=i:e.satoshis=i,0<i)for(var a in r)r[a].txid==e.txid&&(r[a].satoshis=i);return t}function processResult(e,t,r,n){switch(e.type){case"category":return processCategoryResult(e,t,r,n);case"entry":return processEntryResult(e,t,r,n);case"vote":return processVoteResult(e,t,r,n);case"fork":return processForkResult(e,t,n);default:return console.log("error processing result",e),t}}function parseTransactionAddressFromURL(e){for(var t=0,r=SUPPORTED_TIPCHAIN_PROTOCOLS;t<r.length;t++){var n=r[t],o=e.split(n);if(2==o.length){var i=o[1];if(64==i.length)return i}}return null}function parseTipFromEntryMedia(e,t){for(var r=0,n=SUPPORTED_TIPCHAIN_PROTOCOLS;r<n.length;r++){var o=n[r],i=e.link.split(o);if(2==i.length){var a=i[1];if(64==a.length){var c=t[a];if(c)return{address:c.address,type:"media"};console.log("unable to find associated b media for item",e.txid)}}}return null}function updateCategoryMoneyCounts(t){return t.map(function(e){return"category"==e.type&&(e.satoshis=countMoneyUnderObject(e,t),e.votes=countVotesUnderObject(e,t)),e})}function countMoneyUnderObject(e,t){var r=e.satoshis,n=!0,o=!1,i=void 0;try{for(var a,c=t[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){var s=a.value;s.deleted||s.category!=e.txid||(r+=s.satoshis,"category"==s.type&&(r+=countMoneyUnderObject(s,t)))}}catch(e){o=!0,i=e}finally{try{n||null==c.return||c.return()}finally{if(o)throw i}}return r}function countVotesUnderObject(e,t){var r=e.votes,n=!0,o=!1,i=void 0;try{for(var a,c=t[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){var s=a.value;s.deleted||s.category!=e.txid||(r+=s.votes,"category"==s.type&&(r+=countVotesUnderObject(s,t)))}}catch(e){o=!0,i=e}finally{try{n||null==c.return||c.return()}finally{if(o)throw i}}return r}function updateCategoryEntryCounts(t){return t.map(function(e){return"category"==e.type&&(e.entries=countObjectsUnderObject(e,t)),e})}function countObjectsUnderObject(e,t){var r=0,n=!0,o=!1,i=void 0;try{for(var a,c=t[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){var s=a.value;s.deleted||s.category!=e.txid||(r+=1,"category"==s.type&&(r+=countObjectsUnderObject(s,t)))}}catch(e){o=!0,i=e}finally{try{n||null==c.return||c.return()}finally{if(o)throw i}}return r}function expandTipchainInformation(e){for(var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,r=2<arguments.length&&void 0!==arguments[2]?arguments[2]:[],n=e.slice(0).reverse(),o=n.map(function(e){return e.address}),i=calculateTipchainSplits(n).reverse(),a=[],c=0;c<o.length;c++){var s=n[c],l=s.name;if(!l&&s.txid){var u=findObjectByTX(s.txid,r);u&&(l=u.name)}l||(l="");var d=i[c],f=t*d;a.push({address:s.address,type:s.type,split:d,amount:f,name:l})}return a}function convertKeyValues(e){for(var t=JSON.parse(JSON.stringify(e)),r={},n=null,o=null,i=null;i=t.shift();)n?o=i:n=i,n&&o&&(r[n]=o,o=n=null);return r}function calculateTipchainSplits(e){if(0==e.length)return[];for(var t=[],r=1;r<=e.length;r++)t.push(1+Math.log(r));var n=t.reduce(function(e,t){return e+t});return t.map(function(e){return e/n})}function calculateTipPayment(e,t,r){if(!t)return console.log("error while calculating tip payment, invalid amount"),null;if(!r)return console.log("error while calculating tip payment, invalid currency"),null;var n=calculateTipchainSplits(e);if(n.length!=e.length)return console.log("error while calculating tip payment, weights didn't match tipchain length"),null;for(var o=[],i=0;i<e.length;i++){var a="object"==_typeof(e[i])?e[i].address:e[i],c=n[i],s=Math.round(c*t*1e4)/1e4;0<s&&o.push({address:a,value:s,currency:r})}return o}function processOpenDirectoryTransaction(e){var t;if(!e.txid||!e.data||!e.address)return null;var r,n,o=e.txid,i=e.address,a=e.height?e.height:Math.Infinity,c=e.time?e.time:0,s=e.outputs?e.outputs:[],l=Object.values(e.data),u=l.shift(),d=l.shift();if(!o)return console.log("Error while processing open directory transaction: no txid",e),null;if(u!==OPENDIR_PROTOCOL)return{txid:e.txid,address:e.address,height:a,time:c,type:"other"};if(-1==OPENDIR_ACTIONS.indexOf(d))return console.log("Error while processing open directory transaction: invalid action",e),null;if("vote"==d||"undo"==d)r=n=d;else{var f=d.split(".");if(2!=f.length)return console.log("Error while processing open directory transaction: invalid action",e),null;r=f[0],n=f[1]}var y=(_defineProperty(t={type:r},"type",r),_defineProperty(t,"action",n),_defineProperty(t,"txid",o),_defineProperty(t,"address",i),_defineProperty(t,"height",a),_defineProperty(t,"time",c),_defineProperty(t,"outputs",s),t);if("category"==r)if("create"==n)l.length%2==1&&(y.action_id=l.shift()),y.change=convertKeyValues(l);else if("update"==n)y.action_id=l.shift(),y.change=convertKeyValues(l);else if("delete"==n){y.action_id=l.shift();var p=l.shift();p&&(y.description=p,e.description=p)}else console.log("unknown category action",e);else if("entry"==r)if("create"==n)y.action_id=l.shift(),y.change=convertKeyValues(l);else if("update"==n)y.action_id=l.shift(),y.change=convertKeyValues(l);else if("delete"==n){y.action_id=l.shift();var h=l.shift();h&&(y.description=h,e.description=h)}else console.log("unknown entry action",e);else if("vote"==r)y.action_id=l.shift();else if("fork"==r)if(2==l.length)y.fork_url=l.shift();else{if(3!=l.length)return console.log("unknown number of args",e),null;y.fork_url=l.shift(),y.action_id=l.shift()}else"undo"==r?(1==l.length?(y.reference_id=l.shift(),y.action_id=y.reference_id):2==l.length?(y.reference_id=l.shift(),y.action_id=l.shift()):(y.reference_id=l.shift(),y.action_id=l.shift(),y.description=l.shift()),y.reference_id&&(e.reference_id=y.reference_id),y.action_id&&(e.action_id=y.action_id),y.description&&(e.description=y.description)):console.log("unknown item type",e);return y}function convertOutputs(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[],r=0,n=!0,o=!1,i=void 0;try{for(var a,c=e[Symbol.iterator]();!(n=(a=c.next()).done);n=!0){var s=a.value;-1!==t.indexOf(s.address)&&(r+=s.sats)}}catch(e){o=!0,i=e}finally{try{n||null==c.return||c.return()}finally{if(o)throw i}}return r}function findObjectByTX(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[],r=!0,n=!1,o=void 0;try{for(var i,a=t[Symbol.iterator]();!(r=(i=a.next()).done);r=!0){var c=i.value;if(c.txid==e)return c}}catch(e){n=!0,o=e}finally{try{r||null==a.return||a.return()}finally{if(n)throw o}}return null}function findRootActionID(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[];if(!e.action_id)return null;if("undo"==e.type&&e.action_id){var r=findObjectByTX(e.action_id,t);if(r&&"undo"==r.type){var n=findRootActionID(r,t);if(n)return n}}return e.action_id}"undefined"==typeof window&&(module.exports={OPENDIR_PROTOCOL:OPENDIR_PROTOCOL,OPENDIR_ACTIONS:OPENDIR_ACTIONS,fetch_from_network:fetch_from_network,processResults:processResults,processRawResults:processRawResults,processOpenDirectoryTransactions:processOpenDirectoryTransactions,calculateTipchainSplits:calculateTipchainSplits,calculateTipPayment:calculateTipPayment,findObjectByTX:findObjectByTX});
...
"use strict";function _toConsumableArray(e){return _arrayWithoutHoles(e)||_iterableToArray(e)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function _iterableToArray(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function _arrayWithoutHoles(e){if(Array.isArray(e)){for(var t=0,r=new Array(e.length);t<e.length;t++)r[t]=e[t];return r}}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var r=0;r<t.length;r++){var a=t[r];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}function _createClass(e,t,r){return t&&_defineProperties(e.prototype,t),r&&_defineProperties(e,r),e}function _possibleConstructorReturn(e,t){return!t||"object"!==_typeof(t)&&"function"!=typeof t?_assertThisInitialized(e):t}function _assertThisInitialized(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function _getPrototypeOf(e){return(_getPrototypeOf=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&_setPrototypeOf(e,t)}function _setPrototypeOf(e,t){return(_setPrototypeOf=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}var SearchPage=function(){function r(e){var t;return _classCallCheck(this,r),(t=_possibleConstructorReturn(this,_getPrototypeOf(r).call(this,e))).state={search:""},t}return _inherits(r,React.Component),_createClass(r,[{key:"handleSearch",value:function(e){this.setState({search:e.target.value})}},{key:"render",value:function(){return React.createElement("div",{className:"search"},React.createElement(SearchForm,{search:this.state.search,title:this.props.title,onSearch:this.handleSearch.bind(this),category:this.props.category,embed:this.props.embed,changeURL:this.props.changeURL}),this.state.search&&React.createElement(SearchResults,{search:this.state.search,items:this.props.items,changeURL:this.props.changeURL}))}}]),r}(),SearchForm=function(){function e(){return _classCallCheck(this,e),_possibleConstructorReturn(this,_getPrototypeOf(e).apply(this,arguments))}return _inherits(e,React.Component),_createClass(e,[{key:"handleSubmit",value:function(e){e.preventDefault()}},{key:"render",value:function(){var e,t=this;return this.props.category&&this.props.category.name?e=React.createElement("span",null,"Search ",React.createElement("a",{onClick:function(){t.props.changeURL("/category/"+t.props.category.txid)}},this.props.category.name)):this.props.category&&this.props.category.txid?e=React.createElement("span",null,"Search category ",this.props.category.txid.slice(0,5),"..."):this.props.category&&!this.props.category.txid&&(e=React.createElement("span",null,"Search ",React.createElement("a",{onClick:function(){t.props.changeURL("/")}},"Open Directory"))),this.props.embed?React.createElement("div",{className:"search embed"},React.createElement("form",{onSubmit:this.handleSubmit.bind(this)},React.createElement("input",{type:"search",value:this.props.search,onChange:this.props.onSearch.bind(this),placeholder:"Search the Open Directory..."}),React.createElement("input",{type:"submit",className:"button-outline",value:"Search"}))):React.createElement("div",{className:"search page"},React.createElement("h2",null,e),React.createElement("p",{className:"blurb"},"Search by name, description, link, txid, address..."),React.createElement("form",{onSubmit:this.handleSubmit.bind(this)},React.createElement("input",{type:"search",value:this.props.search,onChange:this.props.onSearch.bind(this)}),React.createElement("input",{type:"submit",className:"button-outline",value:"Search"})))}}]),e}(),SearchResults=function(){function r(e){var t;return _classCallCheck(this,r),(t=_possibleConstructorReturn(this,_getPrototypeOf(r).call(this,e))).state={limit:15,cursor:0},t}return _inherits(r,React.Component),_createClass(r,[{key:"handlePageChange",value:function(e){var t=(e-1)*this.state.limit;this.setState({cursor:t}),window.scrollTo(0,250)}},{key:"render",value:function(){var r=this,i=this.props.search.toLowerCase(),e=this.props.items.filter(function(e){if(e.name&&-1!==e.name.toLowerCase().indexOf(i))return!0;if(e.description&&-1!==e.description.toLowerCase().indexOf(i))return!0;if(e.txid&&-1!==e.txid.toLowerCase().indexOf(i))return!0;if(e.address&&-1!==e.address.toLowerCase().indexOf(i))return!0;if(e.link&&-1!==e.link.toLowerCase().indexOf(i))return!0;var t=!0,r=!1,a=void 0;try{for(var s,n=e.tipchain[Symbol.iterator]();!(t=(s=n.next()).done);t=!0){if(-1!==s.value.address.toLowerCase().indexOf(i))return!0}}catch(e){r=!0,a=e}finally{try{t||null==n.return||n.return()}finally{if(r)throw a}}return!1}),t=e.sort(function(e,t){return e.hottness<t.hottness?1:e.hottness>t.hottness?-1:e.satoshis<t.satoshis?1:e.satoshis>t.satoshis?-1:e.votes<t.votes?1:e.votes>t.votes?-1:e.height<t.height?1:e.height>t.height?-1:0}).slice(this.state.cursor,this.state.cursor+this.state.limit),a=Math.ceil(e.length/this.state.limit),s=_toConsumableArray(Array(a).keys()).map(function(e){var t=e+1;return React.createElement("a",{key:"page-"+t,className:r.state.cursor==e*r.state.limit?"active":null,onClick:function(){r.handlePageChange(t)}},t)});return React.createElement("div",null,React.createElement("ul",{className:"search-results"},t.map(function(e){return React.createElement(SearchResult,{key:e.txid,item:e,items:r.props.items,changeURL:r.props.changeURL})})),React.createElement("p",{className:"num-results"},"Found ",pluralize(e.length,"result","results")),1<s.length&&React.createElement("div",{className:"pages"},s))}}]),r}(),SearchResult=function(){function e(){return _classCallCheck(this,e),_possibleConstructorReturn(this,_getPrototypeOf(e).apply(this,arguments))}return _inherits(e,React.Component),_createClass(e,[{key:"render",value:function(){var e,t=this;if("category"==this.props.item.type)return e=this.props.item.txid?"/category/"+this.props.item.txid:"/",React.createElement("div",{className:"search-result"},React.createElement("h4",null,React.createElement("a",{onClick:function(){t.props.changeURL(e)}},this.props.item.name)," ",React.createElement("span",{className:"badge badge-type-"+this.props.item.type},this.props.item.type)),"entry"==this.props.item.type&&React.createElement("a",{className:"url",href:this.props.item.link},this.props.item.link),React.createElement("div",{className:"satoshis"},satoshisToDollars(this.props.item.satoshis)),React.createElement(ReactMarkdown,{source:this.props.item.description}));if("entry"==this.props.item.type){var r=this.props.item.link,a=findObjectByTX(this.props.item.category,this.props.items);return React.createElement("div",{className:"search-result"},React.createElement("h4",null,React.createElement("a",{href:r},this.props.item.name)," ",React.createElement("span",{className:"badge badge-type-"+this.props.item.type},this.props.item.type)," ",React.createElement("span",{className:"from-category-prefix"},"in")," ",React.createElement("a",{className:"from-category",onClick:function(){t.props.changeURL("/category/"+a.txid)}},a.name)),"entry"==this.props.item.type&&React.createElement("a",{className:"url",href:this.props.item.link},this.props.item.link),React.createElement("div",{className:"satoshis"},satoshisToDollars(this.props.item.satoshis)),React.createElement(ReactMarkdown,{source:this.props.item.description}))}}}]),e}();
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function _createClass(e,t,n){return t&&_defineProperties(e.prototype,t),n&&_defineProperties(e,n),e}function _possibleConstructorReturn(e,t){return!t||"object"!==_typeof(t)&&"function"!=typeof t?_assertThisInitialized(e):t}function _getPrototypeOf(e){return(_getPrototypeOf=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function _assertThisInitialized(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&_setPrototypeOf(e,t)}function _setPrototypeOf(e,t){return(_setPrototypeOf=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}var TipchainItem=function(){function n(e){var t;return _classCallCheck(this,n),(t=_possibleConstructorReturn(this,_getPrototypeOf(n).call(this,e))).state={showingTipchain:!1,tip:SETTINGS.tip_amount,rand:Math.random().toString(36).substring(2,15)+Math.random().toString(36).substring(2,15)},t.handleTipSubmit=t.handleTipSubmit.bind(_assertThisInitialized(t)),t.handleClickTip=t.handleClickTip.bind(_assertThisInitialized(t)),t}return _inherits(n,React.Component),_createClass(n,[{key:"componentDidMount",value:function(){window.addEventListener("popstate",this.clearMoneyButton.bind(this),!1),this.handleTipSubmit()}},{key:"componentWillUnmount",value:function(){window.removeEventListener("popstate",this.clearMoneyButton.bind(this))}},{key:"clearMoneyButton",value:function(){var e=document.getElementById(this.state.rand);if(e){var t=e.querySelector(".tip-money-button");if(t){var n=t.parentNode;n.removeChild(t);var i=document.createElement("div");i.className="tip-money-button",n.appendChild(i)}}}},{key:"handleTipSubmit",value:function(e){var t,n=this;if(e&&e.preventDefault(),!(t=this.props.custom_OP_RETURN?this.props.custom_OP_RETURN(this.props.item.txid):[OPENDIR_PROTOCOL,"vote",this.props.item.txid])||0==t.length)return alert("Invalid OP_RETURN generated for tip... please try again or contact the developers");console.log("OP_RETURN",t);var i=this.get_tipchain();if(i&&0!=i.length||confirm("Tipchain is invalid, please refresh or press OK to continue anyway")){var a=Number(this.state.tip);console.log("tipchain",i);var o=calculateTipPayment(i,a,SETTINGS.currency);console.log("payments",o);var r=document.getElementById(this.state.rand).querySelector(".tip-money-button");databutton.build({data:t,button:{$el:r,label:"upvote",$pay:{to:o},onPayment:function(e){console.log(e);var t=get_local_settings();t.tip_amount=a,use_local_settings(t),save_local_settings(t),setTimeout(function(){n.clearMoneyButton(),n.props.onSuccessHandler()},5e3)}}})}}},{key:"handleClickTip",value:function(e){var t=this,n=e.currentTarget.dataset.value;0<n&&this.setState({tip:n},function(){t.handleTipSubmit()})}},{key:"handleChangeTip",value:function(e){this.setState({tip:e.target.value})}},{key:"handleClickTipchain",value:function(e){this.setState({showingTipchain:!this.state.showingTipchain})}},{key:"get_tipchain",value:function(){return null==this.props.item.txid?SETTINGS.tip_addresses:this.props.item.tipchain}},{key:"render",value:function(){var e=expandTipchainInformation(this.get_tipchain(),this.state.tip,this.props.items);return React.createElement("div",{className:"tipping"},React.createElement("form",{onSubmit:this.handleTipSubmit.bind(this)},React.createElement("label",null,"Tip  ",React.createElement("a",{className:"suggested-tip","data-value":"0.05",onClick:this.handleClickTip},"5¢"),React.createElement("a",{className:"suggested-tip","data-value":"0.10",onClick:this.handleClickTip},"10¢"),React.createElement("a",{className:"suggested-tip","data-value":"0.25",onClick:this.handleClickTip},"25¢"),React.createElement("a",{className:"suggested-tip","data-value":"1.00",onClick:this.handleClickTip},"$1.00"),"$"),React.createElement("input",{className:"tip",type:"text",placeholder:"0.05",value:this.state.tip,onChange:this.handleChangeTip.bind(this)})," ",React.createElement("input",{type:"submit",className:"button button-outline",value:"tip"})),React.createElement("hr",null),React.createElement("div",{className:"tipchain"},React.createElement("p",null,React.createElement("a",{onClick:this.handleClickTipchain.bind(this)},pluralize(e.length,"address","addresses"))," in this tipchain"),this.state.showingTipchain&&React.createElement("ul",null,e.map(function(e,t){(100*Number(e.split)).toFixed(2);var n=t+e.type+e.address+e.split,i=Number(e.amount).toFixed(2);return 0<e.amount&&"0.00"==i&&(i=Number(e.amount).toFixed(3)),"opendirectory"==e.type?React.createElement("li",{key:n},"$",i," to ",React.createElement("strong",null,e.name)," ",e.address):"media"==e.type?React.createElement("li",{key:n},"$",i," to original content owner ",React.createElement("strong",null,e.address)):"category"==e.type?React.createElement("li",{key:n},"$",i," to ",React.createElement("strong",null,e.name)," category creator ",e.address):"entry"==e.type?React.createElement("li",{key:n},"$",i," to ",React.createElement("strong",null,e.name)," entry submitter ",e.address):React.createElement("li",{key:n},"$",i," ",React.createElement("strong",null,e.name)," ",e.address)})),React.createElement("div",{className:"money-button-wrapper",id:this.state.rand},React.createElement("div",{className:"tip-money-button"}))))}}]),n}();
...
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function _createClass(e,t,n){return t&&_defineProperties(e.prototype,t),n&&_defineProperties(e,n),e}function _possibleConstructorReturn(e,t){return!t||"object"!==_typeof(t)&&"function"!=typeof t?_assertThisInitialized(e):t}function _assertThisInitialized(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function _getPrototypeOf(e){return(_getPrototypeOf=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&_setPrototypeOf(e,t)}function _setPrototypeOf(e,t){return(_setPrototypeOf=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}var EntryItem=function(){function e(){return _classCallCheck(this,e),_possibleConstructorReturn(this,_getPrototypeOf(e).apply(this,arguments))}return _inherits(e,Item),_createClass(e,[{key:"get_link",value:function(){return 0==this.props.item.link.indexOf("http")?this.props.item.link:isBottle()?this.props.item.link:"https://bico.media/"+this.props.item.link}},{key:"render",value:function(){var e=this,t=(new Date).getTime(),n=satoshisToDollars(this.props.item.satoshis,BSV_PRICE,!0),i=findObjectByTX(this.props.item.category,this.props.items),a=React.createElement("span",{className:"actions"},React.createElement("a",{onClick:this.handleToggleExpand.bind(this),className:"arrow",title:"txid "+this.props.item.txid},this.state.isExpanded?React.createElement("i",{className:"fas fa-caret-right"}):React.createElement("i",{className:"fas fa-caret-down"})),this.state.isExpanded&&React.createElement("a",{className:"action",onClick:this.handleEdit.bind(this)},"edit"),this.state.isExpanded&&React.createElement("a",{className:"action",onClick:this.handleDelete.bind(this)},"delete"));return React.createElement("li",{id:this.props.item.txid,className:"entry"},React.createElement("div",{className:"upvoteContainer"},React.createElement("div",{className:"upvote"},React.createElement("a",{onClick:this.handleUpvote.bind(this)},React.createElement("i",{className:"fas fa-chevron-up"}))," ",React.createElement("span",{className:"number satoshis",title:this.props.item.satoshis+" sats"},n),React.createElement("span",{className:"number votes",title:this.props.item.hottness.toFixed(2)+" hot score"},pluralize(this.props.item.votes,"vote","votes"))),React.createElement("div",{className:"entry"},React.createElement("h5",null,React.createElement("a",{target:"_blank",href:this.get_link()},this.props.item.name)," ",!this.props.item.height&&React.createElement("span",{className:"pending"},"pending"),"  ",this.props.showCategory&&React.createElement("span",null,React.createElement("span",{className:"from-category-prefix"},"in")," ",React.createElement("a",{className:"from-category",onClick:function(){e.props.changeURL("/category/"+i.txid)}},i.name))," ",React.createElement("span",{className:"time"},timeDifference(t,1e3*this.props.item.time))," ",a),React.createElement("p",{className:"description"},this.props.item.description),React.createElement("p",{className:"url"},React.createElement("a",{target:"_blank",href:this.get_link()},this.props.item.link)),"editing"==this.state.action&&React.createElement("div",{className:"inline-edit"},React.createElement(EditEntryForm,{item:this.props.item,onSuccessHandler:this.props.onSuccessHandler,onErrorHandler:this.props.onErrorHandler,onSubmit:this.clearForm.bind(this)})),"tipping"==this.state.action&&React.createElement(TipchainItem,{item:this.props.item,items:this.props.items,onSuccessHandler:this.handleSuccessfulTip.bind(this),onErrorHandler:this.props.onErrorHandler}),"deleting"==this.state.action&&React.createElement("div",{className:"inline-delete"},React.createElement(DeleteItem,{item:this.props.item,onSuccessHandler:this.handleSuccessfulDelete.bind(this),onErrorHandler:this.props.onErrorHandler}))),React.createElement("div",{className:"clearfix"})))}}]),e}(),AddEntryForm=function(){function n(e){var t;return _classCallCheck(this,n),(t=_possibleConstructorReturn(this,_getPrototypeOf(n).call(this,e))).state={title:"",link:"",description:""},t._isMounted=!1,t.handleTitleChange=t.handleTitleChange.bind(_assertThisInitialized(t)),t.handleLinkChange=t.handleLinkChange.bind(_assertThisInitialized(t)),t.handleDescriptionChange=t.handleDescriptionChange.bind(_assertThisInitialized(t)),t.handleSubmit=t.handleSubmit.bind(_assertThisInitialized(t)),t}return _inherits(n,React.Component),_createClass(n,[{key:"render",value:function(){return React.createElement("div",{className:"column"},React.createElement("h3",null,React.createElement("i",{className:"fas fa-link"})," Add new link to ",React.createElement("span",{className:"highlight"},this.props.category.name)),React.createElement("p",null,"Submit a link and earn money when it gets upvoted. Keep it high-quality, remember this action is forever tied to your Bitcoin address."),React.createElement("form",{onSubmit:this.handleSubmit},React.createElement("fieldset",null,React.createElement("div",{className:"row"},React.createElement("div",{className:"column"},React.createElement("label",null,"Title:",React.createElement("input",{type:"text",value:this.state.title,onChange:this.handleTitleChange}))),React.createElement("div",{className:"column"})),React.createElement("label",null,"Link:",React.createElement("input",{type:"text",value:this.state.link,onChange:this.handleLinkChange,placeholder:"bit://"})),React.createElement("label",null,"Description:",React.createElement("textarea",{onChange:this.handleDescriptionChange,value:this.state.description})),React.createElement("input",{type:"submit",className:"button-outline",value:"Add new link"}),React.createElement("div",null,React.createElement("div",{className:"add-entry-money-button"})))))}},{key:"handleSubmit",value:function(e){var t=this;if(e.preventDefault(),this.validate()){var n=[OPENDIR_PROTOCOL,"entry.create",this.props.category.txid,"name",this.state.title,"link",this.state.link,"description",this.state.description];console.log(n);var i=document.querySelector(".add-entry-money-button");databutton.build({data:n,button:{$el:i,onPayment:function(e){console.log(e),setTimeout(function(){t.clearForm()},5e3),setTimeout(function(){t.setState({title:"",link:"",description:""}),t.props.onSuccessHandler("Successfully added new link, it will appear automatically—please refresh the page if it doesn't.")},3e3)}}})}}}]),_createClass(n,[{key:"componentDidMount",value:function(){window.addEventListener("popstate",this.clearForm.bind(this),!1),this._isMounted=!0}},{key:"componentWillUnmount",value:function(){window.removeEventListener("popstate",this.clearForm.bind(this)),this._isMounted=!1}},{key:"clearForm",value:function(){if(this._isMounted){var e=document.querySelector(".add-entry-money-button");if(e){var t=e.parentNode;t.removeChild(e);var n=document.createElement("div");n.className="add-entry-money-button",t.appendChild(n)}this.setState({title:"",link:"",description:""})}}},{key:"validate",value:function(){return this.props.category?this.state.title?this.state.link?!(-1==this.state.link.indexOf("://")&&!confirm("The link doesn't look valid, are you sure you want to continue?"))&&(!!this.state.description||(alert("Invalid description"),!1)):(alert("Invalid link"),!1):(alert("Invalid title"),!1):(alert("Invalid category"),!1)}},{key:"handleTitleChange",value:function(e){this.setState({title:e.target.value})}},{key:"handleLinkChange",value:function(e){this.setState({link:e.target.value})}},{key:"handleDescriptionChange",value:function(e){this.setState({description:e.target.value})}}]),n}(),EditEntryForm=function(){function n(e){var t;return _classCallCheck(this,n),(t=_possibleConstructorReturn(this,_getPrototypeOf(n).call(this,e))).state={title:e.item.name,link:e.item.link,description:e.item.description,isShowingWarning:!1},t._isMounted=!1,t.handleTitleChange=t.handleTitleChange.bind(_assertThisInitialized(t)),t.handleLinkChange=t.handleLinkChange.bind(_assertThisInitialized(t)),t.handleDescriptionChange=t.handleDescriptionChange.bind(_assertThisInitialized(t)),t.handleSubmit=t.handleSubmit.bind(_assertThisInitialized(t)),t}return _inherits(n,React.Component),_createClass(n,[{key:"componentDidMount",value:function(){window.addEventListener("popstate",this.clearForm.bind(this),!1),this._isMounted=!0}},{key:"componentWillUnmount",value:function(){window.removeEventListener("popstate",this.clearForm.bind(this)),this._isMounted=!1}},{key:"clearForm",value:function(){if(this._isMounted){var e=document.getElementById(this.props.item.txid).querySelector(".change-entry-money-button");if(e){var t=e.parentNode;t.removeChild(e);var n=document.createElement("div");n.className="change-entry-money-button",t.appendChild(n)}this.setState({title:"",link:"",description:"",isShowingWarning:!1})}}},{key:"validate",value:function(){return this.state.title?this.state.link?!(-1==this.state.link.indexOf("://")&&!confirm("The link doesn't look valid, are you sure you want to continue?"))&&(!!this.state.description||(alert("Invalid description"),!1)):(alert("Invalid link"),!1):(alert("Invalid title"),!1)}},{key:"handleTitleChange",value:function(e){this.setState({title:e.target.value})}},{key:"handleLinkChange",value:function(e){this.setState({link:e.target.value})}},{key:"handleDescriptionChange",value:function(e){this.setState({description:e.target.value})}},{key:"render",value:function(){return React.createElement("div",{className:"column"},React.createElement("h3",null,"Edit link ",React.createElement("span",{className:"highlight"},this.props.item.name)),React.createElement("form",{onSubmit:this.handleSubmit},React.createElement("fieldset",null,React.createElement("div",{className:"row"},React.createElement("div",{className:"column"},React.createElement("label",null,"Title:",React.createElement("input",{type:"text",value:this.state.title,onChange:this.handleTitleChange}))),React.createElement("div",{className:"column"})),React.createElement("label",null,"Link:",React.createElement("input",{type:"text",value:this.state.link,onChange:this.handleLinkChange,placeholder:"bit://"})),React.createElement("label",null,"Description:",React.createElement("textarea",{onChange:this.handleDescriptionChange,value:this.state.description})),React.createElement("input",{type:"submit",className:"button-outline",value:"Edit link"}),React.createElement("div",null,this.state.isShowingWarning&&React.createElement("div",{className:"notice"},React.createElement("span",{className:"warning"},"You are editing this link, are you sure you want to do this?"),React.createElement("div",{className:"explain"},React.createElement("p",null,"If you change this link you'll be permanently changing it in this directory for everyone else. Please only do this if you think it's in the best interest of the directory. Your Bitcoin key is forever tied to this transaction, so it will always be traced to you."),React.createElement("p",null,React.createElement("strong",null,"Permanently change this link?")),React.createElement("div",{className:"change-entry-money-button"})," "))))))}},{key:"handleSubmit",value:function(e){var i=this;if(e.preventDefault(),this.validate()){var t=[OPENDIR_PROTOCOL,"entry.update",this.props.item.txid],n=!1;this.props.item.name!=this.state.title&&(t.push("name"),t.push(this.state.title),n=!0),this.props.item.link!=this.state.link&&(t.push("link"),t.push(this.state.link),n=!0),this.props.item.description!=this.state.description&&(t.push("description"),t.push(this.state.description),n=!0),n?(console.log(t),this.setState({isShowingWarning:!0},function(){var e=document.getElementById(i.props.item.txid).querySelector(".change-entry-money-button");databutton.build({data:t,button:{$el:e,onPayment:function(e){console.log(e),setTimeout(function(){var e=i.state.title,t=i.state.description,n=i.state.link;i.clearForm(),i.setState({title:e,description:t,link:n}),i.props.onSubmit()},5e3),setTimeout(function(){i.setState({title:"",link:"",description:""}),i.props.onSuccessHandler("Successfully edited new link, it will appear automatically—please refresh the page if it doesn't.")},3e3)}}})})):alert("Nothing was edited with the category, please try again")}}}]),n}();
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var a=0;a<t.length;a++){var n=t[a];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function _createClass(e,t,a){return t&&_defineProperties(e.prototype,t),a&&_defineProperties(e,a),e}function _possibleConstructorReturn(e,t){return!t||"object"!==_typeof(t)&&"function"!=typeof t?_assertThisInitialized(e):t}function _assertThisInitialized(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function _getPrototypeOf(e){return(_getPrototypeOf=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&_setPrototypeOf(e,t)}function _setPrototypeOf(e,t){return(_setPrototypeOf=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}var CategoryItem=function(){function e(){return _classCallCheck(this,e),_possibleConstructorReturn(this,_getPrototypeOf(e).apply(this,arguments))}return _inherits(e,Item),_createClass(e,[{key:"render",value:function(){var e=this,t=satoshisToDollars(this.props.item.satoshis,BSV_PRICE,!0);return React.createElement("li",{id:this.props.item.txid,className:"category"},React.createElement("div",{className:"upvoteContainer"},React.createElement("div",{className:"upvote"},React.createElement("a",{onClick:this.handleUpvote.bind(this)},React.createElement("i",{className:"fas fa-chevron-up"})," ")," ",React.createElement("span",{className:"number satoshis",title:this.props.item.satoshis+" sats"},t),React.createElement("span",{className:"number votes",title:this.props.item.hottness+" hottness"},pluralize(this.props.item.votes,"vote","votes"))),React.createElement("div",{className:"category"},React.createElement("h3",null,React.createElement("a",{onClick:function(){e.props.changeURL("/category/"+e.props.item.txid)}},this.props.item.name),!this.props.item.height&&React.createElement("span",{className:"pending"},"pending"),React.createElement("span",{className:"category-count"},"(",this.props.item.entries,")")),React.createElement(ReactMarkdown,{className:"description",source:this.props.item.description}),"tipping"==this.state.action&&React.createElement(TipchainItem,{item:this.props.item,items:this.props.items,onSuccessHandler:this.handleSuccessfulTip.bind(this),onErrorHandler:this.props.onErrorHandler})),React.createElement("div",{className:"clearfix"})))}}]),e}(),AddCategoryForm=function(){function a(e){var t;return _classCallCheck(this,a),(t=_possibleConstructorReturn(this,_getPrototypeOf(a).call(this,e))).state={title:"",description:""},t._isMounted=!1,t.handleTitleChange=t.handleTitleChange.bind(_assertThisInitialized(t)),t.handleLinkChange=t.handleLinkChange.bind(_assertThisInitialized(t)),t.handleDescriptionChange=t.handleDescriptionChange.bind(_assertThisInitialized(t)),t.handleSubmit=t.handleSubmit.bind(_assertThisInitialized(t)),t}return _inherits(a,React.Component),_createClass(a,[{key:"render",value:function(){var e;this.props.category.txid;return e=this.props.category.txid?React.createElement("div",null,React.createElement("h3",null,React.createElement("i",{className:"fas fa-folder"})," Add new subcategory under ",React.createElement("span",{className:"highlight"},this.props.category.name)),React.createElement("p",null,"Submit a new subcategory to earn money when links get submitted and upvoted. Keep it high-quality, remember this action is forever tied to your Bitcoin address.")):React.createElement("div",null,React.createElement("h3",null,React.createElement("i",{className:"fas fa-folder"})," Add new directory"),React.createElement("p",null,"Submit a new directory to earn money when links and categories get submitted and upvoted. Keep it high-quality, remember this action is forever tied to your Bitcoin address.")),React.createElement("div",{className:"column",id:this.getCategoryID()},e,React.createElement("form",{onSubmit:this.handleSubmit},React.createElement("fieldset",null,React.createElement("div",{className:"row"},React.createElement("div",{className:"column"},React.createElement("label",null,"Title:",React.createElement("input",{type:"text",value:this.state.title,onChange:this.handleTitleChange}))),React.createElement("div",{className:"column"})),React.createElement("label",null,"Description:",React.createElement("textarea",{onChange:this.handleDescriptionChange,value:this.state.description})),React.createElement("input",{type:"submit",className:"button button-outline",value:this.props.category.txid?"Add new subcategory":"Add new directory"}),React.createElement("div",null,React.createElement("div",{className:"add-category-money-button"})))))}},{key:"handleSubmit",value:function(e){var t=this;if(e.preventDefault(),this.validate()){var a=[OPENDIR_PROTOCOL,"category.create"];this.props.category.txid&&a.push(this.props.category.txid),a.push("name"),a.push(this.state.title),a.push("description"),a.push(this.state.description),console.log(a);var n=document.querySelector(".add-category-money-button");databutton.build({data:a,button:{$el:n,onPayment:function(e){console.log(e),setTimeout(function(){t.clearForm()},5e3),setTimeout(function(){t.setState({title:"",description:""}),t.props.category.txid?t.props.onSuccessHandler("Successfully added new category, it will appear automatically—please refresh the page if it doesn't."):t.props.onSuccessHandler("Successfully added new category. Due to heavy demand we're caching the front page longer, so please wait up to a minute and refresh. We're working on resolving this ASAP!")},3e3)}}})}}},{key:"getCategoryID",value:function(){return this.props.category.txid?this.props.category.txid:"root-category"}},{key:"componentDidMount",value:function(){window.addEventListener("popstate",this.clearForm.bind(this),!1),this._isMounted=!0}},{key:"componentWillUnmount",value:function(){window.removeEventListener("popstate",this.clearForm.bind(this)),this._isMounted=!1}},{key:"clearForm",value:function(){if(this._isMounted){var e=document.querySelector(".add-category-money-button");if(e){var t=e.parentNode;t.removeChild(e);var a=document.createElement("div");a.className="add-category-money-button",t.appendChild(a)}this.setState({title:"",description:""})}}},{key:"validate",value:function(){return this.state.title?!!this.state.description||(alert("Invalid description"),!1):(alert("Invalid title"),!1)}},{key:"handleTitleChange",value:function(e){this.setState({title:e.target.value})}},{key:"handleLinkChange",value:function(e){this.setState({link:e.target.value})}},{key:"handleDescriptionChange",value:function(e){this.setState({description:e.target.value})}}]),a}(),EditCategoryForm=function(){function a(e){var t;return _classCallCheck(this,a),(t=_possibleConstructorReturn(this,_getPrototypeOf(a).call(this,e))).state={title:e.category.name,description:e.category.description,isShowingWarning:!1},t._isMounted=!1,t.handleTitleChange=t.handleTitleChange.bind(_assertThisInitialized(t)),t.handleLinkChange=t.handleLinkChange.bind(_assertThisInitialized(t)),t.handleDescriptionChange=t.handleDescriptionChange.bind(_assertThisInitialized(t)),t.handleSubmit=t.handleSubmit.bind(_assertThisInitialized(t)),t}return _inherits(a,React.Component),_createClass(a,[{key:"render",value:function(){return React.createElement("div",{className:"column",id:this.getCategoryID()},React.createElement("h3",null,"Edit ",React.createElement("span",{className:"highlight"},this.props.category.name)),React.createElement("form",{onSubmit:this.handleSubmit},React.createElement("fieldset",null,React.createElement("div",{className:"row"},React.createElement("div",{className:"column"},React.createElement("label",null,"Title:",React.createElement("input",{type:"text",value:this.state.title,onChange:this.handleTitleChange}))),React.createElement("div",{className:"column"})),React.createElement("label",null,"Description:",React.createElement("textarea",{onChange:this.handleDescriptionChange,value:this.state.description})),React.createElement("input",{type:"submit",className:"button button-outline",value:"Edit category"}),React.createElement("div",null,this.state.isShowingWarning&&React.createElement("div",{className:"notice"},React.createElement("span",{className:"warning"},"You are editing this category, are you sure you want to do this?"),React.createElement("div",{className:"explain"},React.createElement("p",null,"If you change this category you'll be permanently changing it in this directory for everyone else. Please only do this if you think it's in the best interest of the directory. Your Bitcoin key is forever tied to this transaction, so it will always be traced to you."),React.createElement("p",null,React.createElement("strong",null,"Permanently change this category?")),React.createElement("div",{className:"change-category-money-button"})," "))))))}},{key:"handleSubmit",value:function(e){var a=this;if(e.preventDefault(),this.validate())if(this.props.category.txid){var t=[OPENDIR_PROTOCOL,"category.update",this.props.category.txid],n=!1;this.props.category.name!=this.state.title&&(t.push("name"),t.push(this.state.title),n=!0),this.props.category.description!=this.state.description&&(t.push("description"),t.push(this.state.description),n=!0),n?this.setState({isShowingWarning:!0},function(){console.log(t);var e=document.getElementById(a.getCategoryID()).querySelector(".change-category-money-button");databutton.build({data:t,button:{$el:e,onPayment:function(e){console.log(e),setTimeout(function(){var e=a.state.title,t=a.state.description;a.clearForm(),a.setState({title:e,description:t}),a.props.onSubmit()},5e3),setTimeout(function(){a.props.onSuccessHandler("Successfully edited category, it will appear automatically—please refresh the page if it doesn't.")},3e3)}}})}):alert("Nothing was edited with the category, please try again")}else alert("An unknown error occured, category doesn't have a txid to edit")}},{key:"getCategoryID",value:function(){return this.props.category.txid?this.props.category.txid:"root-category"}},{key:"componentDidMount",value:function(){window.addEventListener("popstate",this.clearForm.bind(this),!1),this._isMounted=!0}},{key:"componentWillUnmount",value:function(){window.removeEventListener("popstate",this.clearForm.bind(this)),this._isMounted=!1}},{key:"clearForm",value:function(){if(this._isMounted){var e=document.getElementById(this.getCategoryID()).querySelector(".change-category-money-button");if(e){var t=e.parentNode;t.removeChild(e);var a=document.createElement("div");a.className="change-category-money-button",t.appendChild(a)}this.setState({title:"",description:"",isShowingWarning:!1})}}},{key:"validate",value:function(){return this.state.title?!!this.state.description||(alert("Invalid description"),!1):(alert("Invalid title"),!1)}},{key:"handleTitleChange",value:function(e){this.setState({title:e.target.value})}},{key:"handleLinkChange",value:function(e){this.setState({link:e.target.value})}},{key:"handleDescriptionChange",value:function(e){this.setState({description:e.target.value})}}]),a}(),AddDirectoryPage=function(){function e(){return _classCallCheck(this,e),_possibleConstructorReturn(this,_getPrototypeOf(e).apply(this,arguments))}return _inherits(e,React.Component),_createClass(e,[{key:"render",value:function(){return React.createElement("div",null,React.createElement("br",null),React.createElement(AddCategoryForm,{category:this.props.category,onSuccessHandler:this.props.onSuccessHandler,onErrorHandler:this.props.onErrorHandler}))}}]),e}();
"use strict";function _toConsumableArray(e){return _arrayWithoutHoles(e)||_iterableToArray(e)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function _iterableToArray(e){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e))return Array.from(e)}function _arrayWithoutHoles(e){if(Array.isArray(e)){for(var t=0,a=new Array(e.length);t<e.length;t++)a[t]=e[t];return a}}function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var a=0;a<t.length;a++){var s=t[a];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}function _createClass(e,t,a){return t&&_defineProperties(e.prototype,t),a&&_defineProperties(e,a),e}function _possibleConstructorReturn(e,t){return!t||"object"!==_typeof(t)&&"function"!=typeof t?_assertThisInitialized(e):t}function _assertThisInitialized(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function _getPrototypeOf(e){return(_getPrototypeOf=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&_setPrototypeOf(e,t)}function _setPrototypeOf(e,t){return(_setPrototypeOf=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}var BaseList=function(){function a(e){var t;return _classCallCheck(this,a),(t=_possibleConstructorReturn(this,_getPrototypeOf(a).call(this,e))).state={sort:"hot",limit:e.limit||10,category_limit:10,cursor:0,action:null,isExpanded:!1},t._isMounted=!1,t}return _inherits(a,React.Component),_createClass(a,[{key:"componentDidMount",value:function(){this._isMounted=!0,window.addEventListener("popstate",this.clearForm.bind(this),!1)}},{key:"componentWillUnmount",value:function(){this._isMounted=!1,window.removeEventListener("popstate",this.clearForm.bind(this))}},{key:"clearForm",value:function(){this._isMounted&&this.setState({action:null,isExpanded:!1,cursor:0})}},{key:"findCategoryByTXID",value:function(t){return this.props.items.filter(function(e){return"category"==e.type&&e.txid==t}).shift()}},{key:"handleChangeSortOrder",value:function(e){"time"==e?this.setState({sort:"time",cursor:0}):"votes"==e?this.setState({sort:"votes",cursor:0}):"money"==e?this.setState({sort:"money",cursor:0}):"submissions"==e?this.setState({sort:"submissions",cursor:0}):this.setState({sort:"hot",cursor:0})}},{key:"handlePageChange",value:function(e){var t=(e-1)*this.state.limit;this.setState({cursor:t}),this.scrollToTop()}},{key:"handleSuccessfulTip",value:function(){this.setState({action:null}),this.props.onSuccessHandler("Successfully upvoted "+this.props.category.type+", it will appear automatically—please refresh the page if it doesn't")}},{key:"handleShowAllCategories",value:function(){this.setState({category_limit:-1})}},{key:"handleSuccessfulDelete",value:function(){this.setState({action:null}),this.props.onSuccessHandler("Successfully deleted "+this.props.category.type+", it will appear automatically—please refresh the page if it doesn't")}},{key:"handleUpvote",value:function(e){this.setState({action:"tipping"})}},{key:"handleToggleExpand",value:function(e){this.setState({isExpanded:!this.state.isExpanded,action:null})}},{key:"handleEdit",value:function(e){this.setState({action:"editing"})}},{key:"handleDelete",value:function(e){this.setState({action:"deleting"})}},{key:"getUnsortedCategories",value:function(){var t=this.props.category?this.props.category.txid:get_root_category_txid();return this.props.items.filter(function(e){return!e.deleted&&"category"==e.type&&e.category==t})}},{key:"getUnsortedEntries",value:function(){return this.props.items.filter(function(e){return!e.deleted&&"entry"==e.type})}},{key:"sortCompare",value:function(e,t){if("time"==this.state.sort){if(!e.height)return-1;if(e.height<t.height)return 1;if(e.height>t.height)return-1}else if("votes"==this.state.sort){if(e.votes<t.votes)return 1;if(e.votes>t.votes)return-1;if(e.height<t.height)return 1;if(e.height>t.height)return-1}else if("money"==this.state.sort){if(e.satoshis<t.satoshis)return 1;if(e.satoshis>t.satoshis)return-1;if(e.votes<t.votes)return 1;if(e.votes>t.votes)return-1;if(e.height<t.height)return 1;if(e.height>t.height)return-1}else if("submissions"==this.state.sort){if(e.entries<t.entries)return 1;if(e.entries>t.entries)return-1;if(e.satoshis<t.satoshis)return 1;if(e.satoshis>t.satoshis)return-1;if(e.votes<t.votes)return 1;if(e.votes>t.votes)return-1;if(e.height<t.height)return 1;if(e.height>t.height)return-1}else{if(e.hottness<t.hottness)return 1;if(e.hottness>t.hottness)return-1;if(e.satoshis<t.satoshis)return 1;if(e.satoshis>t.satoshis)return-1;if(e.votes<t.votes)return 1;if(e.votes>t.votes)return-1;if(e.height<t.height)return 1;if(e.height>t.height)return-1}return 0}},{key:"getCategories",value:function(){var a=this;return this.getUnsortedCategories().sort(function(e,t){return a.sortCompare(e,t)})}},{key:"getEntries",value:function(){var a=this;return this.props.category?this.props.items.filter(function(e){return!e.deleted&&"entry"==e.type&&e.category&&e.category==a.props.category.txid}).sort(function(e,t){return a.sortCompare(e,t)}):[]}}]),a}(),SubcategoryList=function(){function e(){return _classCallCheck(this,e),_possibleConstructorReturn(this,_getPrototypeOf(e).apply(this,arguments))}return _inherits(e,BaseList),_createClass(e,[{key:"handleClickShowAllSubcategories",value:function(){this.setState({category_limit:-1})}},{key:"render",value:function(){var e,s=this,t=this.getCategories();e=-1==this.state.category_limit?t:t.slice(0,this.state.category_limit);var a,r,n,i,c=this.getEntries(),l=satoshisToDollars(this.props.category.satoshis,BSV_PRICE,!0),o=c.slice(this.state.cursor,this.state.cursor+this.state.limit),h=Math.ceil(c.length/this.state.limit),m=_toConsumableArray(Array(h).keys()).map(function(e){var t=e+1;return React.createElement("a",{key:"page-"+t,className:s.state.cursor==e*s.state.limit?"active":null,onClick:function(){s.handlePageChange(t)}},t)}),u=React.createElement("span",{className:"actions"},React.createElement("a",{onClick:this.handleToggleExpand.bind(this),className:"arrow",title:"txid "+this.props.category.txid},this.state.isExpanded?React.createElement("i",{class:"fas fa-caret-right"}):React.createElement("i",{className:"fas fa-caret-down"})),this.state.isExpanded&&React.createElement("a",{className:"action",onClick:this.handleEdit.bind(this)},"edit"),this.state.isExpanded&&React.createElement("a",{className:"action",onClick:this.handleDelete.bind(this)},"delete"));if(this.props.category&&this.props.category.category&&(a=this.findCategoryByTXID(this.props.category.category)),this.props.category){if(a){var p=get_root_category_txid();if(null==p||this.props.category.txid!==p){var d="/category/"+a.txid;a.txid==p&&(d="/"),r=React.createElement("div",{className:"back"},React.createElement("a",{onClick:function(){s.props.changeURL(d)}},React.createElement("i",{className:"fas fa-long-arrow-alt-left"})," ",a.name),React.createElement("hr",null))}}this.props.category.name&&(n=React.createElement("div",{className:"category-meta",id:this.props.category.txid},r,React.createElement("div",{className:"upvoteContainer"},React.createElement("div",{className:"upvote"},React.createElement("a",{onClick:this.handleUpvote.bind(this)},React.createElement("i",{className:"fas fa-chevron-up"}))," ",React.createElement("span",{className:"number satoshis",title:this.props.category.satoshis+" sats"},l),React.createElement("span",{className:"number votes",title:this.props.category.hottness+" hottness"},pluralize(this.props.category.votes,"vote","votes"))),React.createElement("div",null,React.createElement("h1",null,this.props.category.name,u),this.state.action&&React.createElement("div",{className:"category-container"},"editing"==this.state.action&&React.createElement("div",{className:"column"},React.createElement(EditCategoryForm,{category:this.props.category,onSuccessHandler:this.props.onSuccessHandler,onErrorHandler:this.props.onErrorHandler,onSubmit:this.clearForm.bind(this)})),"tipping"==this.state.action&&React.createElement(TipchainItem,{item:this.props.category,items:this.props.items,onSuccessHandler:this.handleSuccessfulTip.bind(this),onErrorHandler:this.props.onErrorHandler}),"deleting"==this.state.action&&React.createElement(DeleteItem,{item:this.props.category,onSuccessHandler:this.handleSuccessfulDelete.bind(this),onErrorHandler:this.props.onErrorHandler})),React.createElement("div",{className:"markdown"},React.createElement(ReactMarkdown,{source:this.props.category.description}))),React.createElement("div",{className:"clearfix"}))))}return this.props.category.address&&0<o.length?i=React.createElement("div",null,React.createElement("div",{id:"valid-links-exist"}),React.createElement("div",{className:"controls"},React.createElement("div",{className:"sort"},React.createElement("span",{className:"label"},"sort by"),React.createElement("ul",null,React.createElement("li",null,React.createElement("i",{class:"fab fa-hotjar"})," ",React.createElement("a",{onClick:function(){s.handleChangeSortOrder("hot")},className:"hot"==this.state.sort?"active":""},"hot")),React.createElement("li",null,React.createElement("i",{class:"fas fa-dollar-sign"})," ",React.createElement("a",{onClick:function(){s.handleChangeSortOrder("money")},className:"money"==this.state.sort?"active":""},"money")),React.createElement("li",null,React.createElement("i",{class:"fas fa-poll"})," ",React.createElement("a",{onClick:function(){s.handleChangeSortOrder("votes")},className:"votes"==this.state.sort?"active":""},"votes")),React.createElement("li",null,React.createElement("i",{class:"fas fa-plus"})," ",React.createElement("a",{onClick:function(){s.handleChangeSortOrder("time")},className:"time"==this.state.sort?"active":""},"new"))),React.createElement("div",{className:"clearfix"}))),React.createElement("ul",{className:"entry list"},o.map(function(e){return React.createElement(EntryItem,{key:"entry-"+e.txid,item:e,items:s.props.items,onSuccessHandler:s.props.onSuccessHandler,onErrorHandler:s.props.onErrorHandler,changeURL:s.changeURL})})),1<m.length&&React.createElement("div",{className:"pages"},m)):!this.props.isError&&!this.props.isLoading&&this.props.category&&this.props.category.txid&&(i=React.createElement("div",{className:"empty-entry-listing"},React.createElement("p",null,React.createElement("i",{className:"fas fa-link"})),React.createElement("p",null,"There's no links here yet—you should submit one! If you submit a good one and it gets upvoted, you'll get paid Bitcoin (SV)! 👍"))),React.createElement("div",null,n,t&&0<t.length&&React.createElement("div",{className:"category-wrapper"},React.createElement("ul",{className:"category list"},e.map(function(e,t){var a=React.createElement(CategoryItem,{key:"category-"+e.txid,item:e,items:s.props.items,onSuccessHandler:s.props.onSuccessHandler,onErrorHandler:s.props.onErrorHandler,changeURL:s.props.changeURL});return(t+1)%3==0?[a,React.createElement("div",{key:"category-clearfix-"+t,className:"clearfix three-column"})]:(t+1)%2==0?[a,React.createElement("div",{key:"category-clearfix-"+t,className:"clearfix two-column"})]:a}),React.createElement("div",{className:"clearfix"})),React.createElement("div",{className:"clearfix"}),t.length>e.length&&React.createElement("div",{className:"show-all-subcategories"},React.createElement("i",{class:"fas fa-chevron-circle-down"})," ",React.createElement("a",{onClick:this.handleShowAllCategories.bind(this)},"Show all ",t.length," subcategories"))),i,React.createElement("div",{className:"clearfix"}))}}]),e}(),HomepageEntries=function(){function e(){return _classCallCheck(this,e),_possibleConstructorReturn(this,_getPrototypeOf(e).apply(this,arguments))}return _inherits(e,BaseList),_createClass(e,[{key:"handleChangeEntryLimit",value:function(e){this.setState({limit:e,cursor:0})}},{key:"getHomepageEntries",value:function(){var a=this;return this.props.items.filter(function(e){return!e.deleted&&"entry"==e.type}).sort(function(e,t){return a.sortCompare(e,t)})}},{key:"setCursorWithBoundsCheck",value:function(e){var t=this.getTopHomepageEntries(),a=(Math.ceil(t.length/this.state.limit)-1)*this.state.limit;e<0?e=0:a<e&&(e=a),this.setState({cursor:e})}},{key:"scrollToTop",value:function(){var e=document.querySelector(".homepage.entries .top");e&&e.scrollIntoView(!0)}},{key:"handleNextPageChange",value:function(){this.setCursorWithBoundsCheck(this.state.cursor+this.state.limit),this.scrollToTop()}},{key:"handlePreviousPageChange",value:function(){this.setCursorWithBoundsCheck(this.state.cursor-this.state.limit),this.scrollToTop()}},{key:"getTopHomepageEntries",value:function(e){var t=0<arguments.length&&void 0!==e?e:88;return this.getHomepageEntries().slice(0,t)}},{key:"render",value:function(){var a=this,e=this.getTopHomepageEntries(),t=e.slice(this.state.cursor,this.state.cursor+this.state.limit),s=Math.ceil(e.length/this.state.limit),r=_toConsumableArray(Array(s).keys()).map(function(e){var t=e+1;return React.createElement("a",{key:"page-"+t,className:a.state.cursor==e*a.state.limit?"active":null,onClick:function(){a.handlePageChange(t)}},t)}),n=React.createElement("div",{className:"num_per_page"},React.createElement("span",{className:"label"},"per page"),React.createElement("ul",null,React.createElement("li",null,React.createElement("a",{onClick:function(){a.handleChangeEntryLimit(15)},className:15==this.state.limit?"active":""},"15")),React.createElement("li",null,React.createElement("a",{onClick:function(){a.handleChangeEntryLimit(25)},className:25==this.state.limit?"active":""},"25")),React.createElement("li",null,React.createElement("a",{onClick:function(){a.handleChangeEntryLimit(50)},className:50==this.state.limit?"active":""},"50"))),React.createElement("div",{className:"clearfix"}));0<this.state.cursor?r.unshift(React.createElement("a",{key:"page-previous",onClick:function(){a.handlePreviousPageChange()}},React.createElement("i",{className:"fas fa-angle-double-left"}))):r.unshift(React.createElement("a",{className:"disabled",key:"page-previous"},React.createElement("i",{className:"fas fa-angle-double-left"})));var i=(s-1)*this.state.limit;return this.state.cursor<i?r.push(React.createElement("a",{key:"page-next",onClick:function(){a.handleNextPageChange()}},React.createElement("i",{className:"fas fa-angle-double-right"}))):r.push(React.createElement("a",{className:"disabled",key:"page-next"},React.createElement("i",{className:"fas fa-angle-double-right"}))),0<e.length?React.createElement("div",{className:"homepage entries"},React.createElement("div",{className:"top"}),React.createElement("h3",null,"Trending Links"),React.createElement("div",{className:"controls"},React.createElement("div",{className:"sort"},React.createElement("span",{className:"sort-wrapper"},React.createElement("span",{className:"label"},"sort by"),React.createElement("ul",null,React.createElement("li",null,React.createElement("i",{class:"fab fa-hotjar"})," ",React.createElement("a",{onClick:function(){a.handleChangeSortOrder("hot")},className:"hot"==this.state.sort?"active":""},"hot")),React.createElement("li",null,React.createElement("i",{class:"fas fa-dollar-sign"})," ",React.createElement("a",{onClick:function(){a.handleChangeSortOrder("money")},className:"money"==this.state.sort?"active":""},"money")),React.createElement("li",null,React.createElement("i",{class:"fas fa-poll"})," ",React.createElement("a",{onClick:function(){a.handleChangeSortOrder("votes")},className:"votes"==this.state.sort?"active":""},"votes")),React.createElement("li",null,React.createElement("i",{class:"fas fa-plus"})," ",React.createElement("a",{onClick:function(){a.handleChangeSortOrder("time")},className:"time"==this.state.sort?"active":""},"new"))))),n,React.createElement("div",{className:"clearfix"})),React.createElement("ul",{className:"entry list"},t.map(function(e){return React.createElement(EntryItem,{key:"entry-"+e.txid,item:e,items:a.props.items,onSuccessHandler:a.props.onSuccessHandler,onErrorHandler:a.props.onErrorHandler,showCategory:!0,changeURL:a.props.changeURL})})),1<r.length&&React.createElement("div",{className:"pages"},r),React.createElement("hr",null)):null}}]),e}(),HomepageList=function(){function e(){return _classCallCheck(this,e),_possibleConstructorReturn(this,_getPrototypeOf(e).apply(this,arguments))}return _inherits(e,BaseList),_createClass(e,[{key:"scrollToTop",value:function(){var e=document.querySelector(".homepage-categories .top");e&&e.scrollIntoView(!0)}},{key:"handlePageChange",value:function(e){var t=(e-1)*this.state.category_limit;this.setState({cursor:t}),this.scrollToTop()}},{key:"setCursorWithBoundsCheck",value:function(e){var t=this.getUnsortedCategories(),a=(Math.ceil(t.length/this.state.category_limit)-1)*this.state.category_limit;e<0?e=0:a<e&&(e=a),this.setState({cursor:e})}},{key:"handleNextPageChange",value:function(){this.setCursorWithBoundsCheck(this.state.cursor+this.state.category_limit),this.scrollToTop()}},{key:"handlePreviousPageChange",value:function(){this.setCursorWithBoundsCheck(this.state.cursor-this.state.category_limit),this.scrollToTop()}},{key:"handleChangeCategoryLimit",value:function(e){this.setState({category_limit:e,cursor:0})}},{key:"render",value:function(){var a=this,e=this.getCategories(),t=(satoshisToDollars(this.props.category.satoshis,BSV_PRICE,!0),e.slice(this.state.cursor,this.state.cursor+this.state.category_limit)),s=Math.ceil(e.length/this.state.category_limit),r=_toConsumableArray(Array(s).keys()).map(function(e){var t=e+1;return React.createElement("a",{key:"page-"+t,className:a.state.cursor==e*a.state.category_limit?"active":null,onClick:function(){a.handlePageChange(t)}},t)});0<this.state.cursor?r.unshift(React.createElement("a",{key:"page-previous",onClick:function(){a.handlePreviousPageChange()}},React.createElement("i",{className:"fas fa-angle-double-left"}))):r.unshift(React.createElement("a",{className:"disabled",key:"page-previous"},React.createElement("i",{className:"fas fa-angle-double-left"})));var n=(s-1)*this.state.category_limit;this.state.cursor<n?r.push(React.createElement("a",{key:"page-next",onClick:function(){a.handleNextPageChange()}},React.createElement("i",{className:"fas fa-angle-double-right"}))):r.push(React.createElement("a",{className:"disabled",key:"page-next"},React.createElement("i",{className:"fas fa-angle-double-right"})));var i;React.createElement("span",{className:"actions"},React.createElement("a",{onClick:this.handleToggleExpand.bind(this),className:"arrow",title:"txid "+this.props.category.txid},this.state.isExpanded?React.createElement("i",{class:"fas fa-caret-right"}):React.createElement("i",{className:"fas fa-caret-down"})),this.state.isExpanded&&React.createElement("a",{className:"action",onClick:this.handleEdit.bind(this)},"edit"),this.state.isExpanded&&React.createElement("a",{className:"action",onClick:this.handleDelete.bind(this)},"delete"));if(this.props.category&&this.props.category.category&&(i=this.findCategoryByTXID(this.props.category.category)),this.props.category&&i){var c=get_root_category_txid();if(null==c||this.props.category.txid!==c){var l="/#"+i.txid;i.txid==c&&(l="/#"),React.createElement("div",{className:"back"},React.createElement("a",{href:l},React.createElement("i",{className:"fas fa-long-arrow-alt-left"})," ",i.name),React.createElement("hr",null))}}var o=React.createElement("div",{className:"sort-control"},React.createElement("div",{className:"sort"},React.createElement("span",{className:"label"},"sort by"),React.createElement("ul",null,React.createElement("li",null,React.createElement("i",{className:"fab fa-hotjar"})," ",React.createElement("a",{onClick:function(){a.handleChangeSortOrder("hot")},className:"hot"==this.state.sort?"active":""},"hot")),React.createElement("li",null,React.createElement("i",{className:"fas fa-dollar-sign"})," ",React.createElement("a",{onClick:function(){a.handleChangeSortOrder("money")},className:"money"==this.state.sort?"active":""},"money")),React.createElement("li",null,React.createElement("i",{class:"fas fa-poll"})," ",React.createElement("a",{onClick:function(){a.handleChangeSortOrder("votes")},className:"votes"==this.state.sort?"active":""},"votes")),React.createElement("li",null,React.createElement("i",{class:"fas fa-link"})," ",React.createElement("a",{onClick:function(){a.handleChangeSortOrder("submissions")},className:"submisions"==this.state.sort?"active":""},"links")),React.createElement("li",null,React.createElement("i",{class:"fas fa-plus"})," ",React.createElement("a",{onClick:function(){a.handleChangeSortOrder("time")},className:"time"==this.state.sort?"active":""},"new"))),React.createElement("div",{className:"clearfix"}))),h=React.createElement("div",{className:"num_per_page"},React.createElement("span",{className:"label"},"per page"),React.createElement("ul",null,React.createElement("li",null,React.createElement("a",{onClick:function(){a.handleChangeCategoryLimit(15)},className:15==this.state.category_limit?"active":""},"15")),React.createElement("li",null,React.createElement("a",{onClick:function(){a.handleChangeCategoryLimit(25)},className:25==this.state.category_limit?"active":""},"25")),React.createElement("li",null,React.createElement("a",{onClick:function(){a.handleChangeCategoryLimit(50)},className:50==this.state.category_limit?"active":""},"50"))),React.createElement("div",{className:"clearfix"}));return React.createElement("div",null,e&&0<e.length&&React.createElement("div",{className:"homepage-categories"},React.createElement("div",{className:"top"}),React.createElement("h3",null,"Open Directories"),React.createElement("div",{className:"controls"},o,h,React.createElement("div",{className:"clearfix"})),React.createElement("ul",{className:"category list"},t.map(function(e,t){return React.createElement(CategoryItem,{key:"category-"+e.txid,item:e,items:a.props.items,onSuccessHandler:a.props.onSuccessHandler,onErrorHandler:a.props.onErrorHandler,changeURL:a.props.changeURL})}),React.createElement("div",{className:"clearfix"})),1<r.length&&React.createElement("div",{className:"pages"},r),React.createElement("div",{className:"clearfix"})),React.createElement("div",{className:"clearfix"}))}}]),e}();
