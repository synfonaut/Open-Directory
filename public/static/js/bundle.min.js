  ...
  _createClass(OpenDirectoryApp, [{
    ...
    value: function didUpdateLocation() {
      ...
      if (path == "/faq") {
        ...
        var cached = this.state.cache[null];
        ...
        var _cached = this.state.cache[category_id];
        category = {
          "txid": category_id,
          "needsdata": true
        };
        ...
        if (_cached) {
          items = _cached;
          var cachedCategory = findObjectByTX(category_id, _cached);
    ...
    value: function networkAPIFetch() {
      ...
      setTimeout(function () {
        ...
        fetch_from_network(category_id).then(function (rows) {
          /*
          for (const row of rows) {
              if (row.txid == "dc68afb18d6f3576d82770427199de9ed6e6bc7cc8667f5fc1d46cf8bb590a3e") {
                  console.log(row.txid, JSON.stringify(row, null, 4));
                  throw "E";
              }
          }
          */
