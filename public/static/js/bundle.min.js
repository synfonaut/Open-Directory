...
function updateCategoryMoneyCounts(items) {
  ...
  try {
    for (var _iterator16 = root_categories[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
...
function convertOutputs(outputs) {
  ...
  try {
    for (var _iterator20 = outputs[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
      var output = _step20.value;
...
function addNewRowsToExistingRows(new_rows, existing_rows) {
  ...
  try {
    for (var _iterator23 = existing_rows[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
  ...
  try {
    for (var _iterator24 = new_rows[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
      var _row = _step24.value;
...
function buildItemSliceRepresentationFromCache(category_id) {
  ...
  try {
    for (var _iterator25 = parent_categories[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
      var _txid = _step25.value;
  ...
  while (subcategory_txids.length > 0) {
    ...
    try {
      for (var _iterator26 = found_children[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
...
function buildRawSliceRepresentationFromCache(category_id) {
  ...
  try {
    for (var _iterator28 = changelog[Symbol.iterator](), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
