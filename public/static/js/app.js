class OpenDirectoryApp extends React.Component {
    ...
    componentDidMount() {
        ...
        this.addSuccessMessage("Open Directory just launched and is under a lot of stress, so may be a bit slow. Everything should still load though, give it a few seconds. If you get an error, please refresh.", 10000);
